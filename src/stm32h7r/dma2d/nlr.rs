...
///Field `NL` reader - Number of lines of the area to be transferred.
pub type NL_R = crate::FieldReader<u16>;
///Field `NL` writer - Number of lines of the area to be transferred.
pub type NL_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
///Field `PL` reader - Pixel per lines per lines of the area to be transferred If any of the input image format is 4-bit per pixel, pixel per lines must be even.
pub type PL_R = crate::FieldReader<u16>;
///Field `PL` writer - Pixel per lines per lines of the area to be transferred If any of the input image format is 4-bit per pixel, pixel per lines must be even.
