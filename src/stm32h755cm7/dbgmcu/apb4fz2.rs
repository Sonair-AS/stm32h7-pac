...
impl W {
    ///Bit 7 - I2C4 SMBUS timeout stop in debug
    #[inline(always)]
    pub fn dbg_i2c4(&mut self) -> DBG_I2C4_W<'_, APB4FZ2rs> {
        DBG_I2C4_W::new(self, 7)
    }
    ///Bit 9 - LPTIM2 stop in debug
    #[inline(always)]
    pub fn dbg_lptim2(&mut self) -> DBG_LPTIM2_W<'_, APB4FZ2rs> {
        DBG_LPTIM2_W::new(self, 9)
    }
    ///Bit 10 - LPTIM2 stop in debug
    #[inline(always)]
    pub fn dbg_lptim3(&mut self) -> DBG_LPTIM3_W<'_, APB4FZ2rs> {
        DBG_LPTIM3_W::new(self, 10)
    }
    ///Bit 11 - LPTIM4 stop in debug
    #[inline(always)]
    pub fn dbg_lptim4(&mut self) -> DBG_LPTIM4_W<'_, APB4FZ2rs> {
        DBG_LPTIM4_W::new(self, 11)
    }
    ///Bit 12 - LPTIM5 stop in debug
    #[inline(always)]
    pub fn dbg_lptim5(&mut self) -> DBG_LPTIM5_W<'_, APB4FZ2rs> {
        DBG_LPTIM5_W::new(self, 12)
    }
    ///Bit 16 - RTC stop in debug
    #[inline(always)]
    pub fn dbg_rtc(&mut self) -> DBG_RTC_W<'_, APB4FZ2rs> {
        DBG_RTC_W::new(self, 16)
    }
    ///Bit 18 - LS watchdog for D1 stop in debug
    #[inline(always)]
    pub fn dbg_wdglsd1(&mut self) -> DBG_WDGLSD1_W<'_, APB4FZ2rs> {
        DBG_WDGLSD1_W::new(self, 18)
    }
    ///Bit 19 - LS watchdog for D2 stop in debug
    #[inline(always)]
    pub fn dbg_wdglsd2(&mut self) -> DBG_WDGLSD2_W<'_, APB4FZ2rs> {
