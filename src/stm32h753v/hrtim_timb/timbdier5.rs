...
pub type SET1XDE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIMBDIER5_SPEC, bool, O>;
...
pub type SET1XIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIMBDIER5_SPEC, bool, O>;
