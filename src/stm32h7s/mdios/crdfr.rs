...
///Field `CRDF` reader - clear the read flag Writing 1 to CRDFx clears the RDFx bit in the MDIOS_RDF register.
pub type CRDF_R = crate::FieldReader<u32>;
///Field `CRDF` writer - clear the read flag Writing 1 to CRDFx clears the RDFx bit in the MDIOS_RDF register.
