...
impl RegisterBlock {
    ...
    ///0x15c - FLASH CRC data register
    #[inline(always)]
    pub const fn crcdatar_(&self) -> &CRCDATAR_ {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H750.html#FLASH:ACR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H750.html#FLASH:OPTKEYR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H750.html#FLASH:OPTSR_CUR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H750.html#FLASH:OPTCCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H750.html#FLASH:BOOT_CURR)
...
pub mod boot_curr;
/**BOOT_PRGR (rw) register accessor: FLASH register with boot address

You can [`read`](crate::Reg::read) this register and get [`boot_prgr::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`boot_prgr::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H750.html#FLASH:CRCDATAR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H750.html#FLASH:OPTKEYR_)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H750.html#FLASH:OPTCR_)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H750.html#FLASH:OPTSR_CUR_)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H750.html#FLASH:OPTSR_PRG_)
...
///FLASH register with boot address
pub mod boot_prgr_;
/**CRCDATAR_ (rw) register accessor: FLASH CRC data register

You can [`read`](crate::Reg::read) this register and get [`crcdatar_::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`crcdatar_::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H750.html#FLASH:CRCDATAR_)

For information about available fields see [`mod@crcdatar_`] module*/
pub type CRCDATAR_ = crate::Reg<crcdatar_::CRCDATAR_rs>;
///FLASH CRC data register
pub mod crcdatar_;
