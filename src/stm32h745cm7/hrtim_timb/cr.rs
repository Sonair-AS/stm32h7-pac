...
///Delayed CMP2 mode
pub use crate::stm32h745cm7::hrtim_tima::cr::DELCMP2;
///Field `DELCMP2` reader - Delayed CMP2 mode
pub use crate::stm32h745cm7::hrtim_tima::cr::DELCMP2_R;
///Field `DELCMP2` writer - Delayed CMP2 mode
pub use crate::stm32h745cm7::hrtim_tima::cr::DELCMP2_W;
///Delayed CMP4 mode
pub use crate::stm32h745cm7::hrtim_tima::cr::DELCMP4;
///Field `DELCMP4` reader - Delayed CMP4 mode
pub use crate::stm32h745cm7::hrtim_tima::cr::DELCMP4_R;
///Field `DELCMP4` writer - Delayed CMP4 mode
pub use crate::stm32h745cm7::hrtim_tima::cr::DELCMP4_W;
///Push-Pull mode enable
pub use crate::stm32h745cm7::hrtim_tima::cr::PSHPLL;
///Field `PSHPLL` reader - Push-Pull mode enable
pub use crate::stm32h745cm7::hrtim_tima::cr::PSHPLL_R;
///Field `PSHPLL` writer - Push-Pull mode enable
pub use crate::stm32h745cm7::hrtim_tima::cr::PSHPLL_W;
///Timer x Repetition update
pub use crate::stm32h745cm7::hrtim_tima::cr::TREPU;
///Field `TREPU` reader - Timer x Repetition update
pub use crate::stm32h745cm7::hrtim_tima::cr::TREPU_R;
///Field `TREPU` writer - Timer x Repetition update
pub use crate::stm32h745cm7::hrtim_tima::cr::TREPU_W;
///Timerx reset update
pub use crate::stm32h745cm7::hrtim_tima::cr::TRSTU;
///Field `TRSTU` reader - Timerx reset update
pub use crate::stm32h745cm7::hrtim_tima::cr::TRSTU_R;
///Field `TRSTU` writer - Timerx reset update
pub use crate::stm32h745cm7::hrtim_tima::cr::TRSTU_W;
/**TBU
...
///Master Timer update
pub use crate::stm32h745cm7::hrtim_tima::cr::MSTU;
///Field `MSTU` reader - Master Timer update
pub use crate::stm32h745cm7::hrtim_tima::cr::MSTU_R;
///Field `MSTU` writer - Master Timer update
pub use crate::stm32h745cm7::hrtim_tima::cr::MSTU_W;
///Update Gating
pub use crate::stm32h745cm7::hrtim_tima::cr::UPDGAT;
///Field `UPDGAT` reader - Update Gating
pub use crate::stm32h745cm7::hrtim_tima::cr::UPDGAT_R;
///Field `UPDGAT` writer - Update Gating
pub use crate::stm32h745cm7::hrtim_tima::cr::UPDGAT_W;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H745_CM7.html#HRTIM_TIMB:CR)*/
pub struct CRrs;
