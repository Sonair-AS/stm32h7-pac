...
///Field `CAMEF` reader - Clear AXI master error flag Writing 1 clears the AXI master error flag in the GFXMMU_SR register.
pub type CAMEF_R = crate::BitReader;
///Field `CAMEF` writer - Clear AXI master error flag Writing 1 clears the AXI master error flag in the GFXMMU_SR register.
