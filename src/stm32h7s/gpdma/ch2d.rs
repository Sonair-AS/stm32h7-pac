...
pub use crate::stm32h7s::gpdma::ch::cr;
pub use crate::stm32h7s::gpdma::ch::fcr;
pub use crate::stm32h7s::gpdma::ch::lbar;
pub use crate::stm32h7s::gpdma::ch::sr;
pub use crate::stm32h7s::gpdma::ch::tr1;
pub use crate::stm32h7s::gpdma::ch::tr2;
pub use crate::stm32h7s::gpdma::ch::CR;
pub use crate::stm32h7s::gpdma::ch::FCR;
pub use crate::stm32h7s::gpdma::ch::LBAR;
pub use crate::stm32h7s::gpdma::ch::SR;
...
pub mod br1;
pub use crate::stm32h7s::gpdma::ch::dar;
pub use crate::stm32h7s::gpdma::ch::sar;
pub use crate::stm32h7s::gpdma::ch::DAR;
pub use crate::stm32h7s::gpdma::ch::SAR;
