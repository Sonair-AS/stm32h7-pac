...
pub type PR49_R = crate::BitReader<PR49_A>;
impl PR49_R {
...
pub type PR49_W<'a, const O: u8> = crate::BitWriter<'a, u32, CPUPR2_SPEC, PR49_AW, O>;
...
#[doc = "Configurable event inputs x+32 Pending bit"]
pub use PR49_A as PR51_A;
#[doc = "Configurable event inputs x+32 Pending bit"]
pub use PR49_AW as PR51_AW;
