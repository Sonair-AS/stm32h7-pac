...
/**GPIOA peripheral clock enable in low-power mode
...
///Field `GPIOALPEN` reader - GPIOA peripheral clock enable in low-power mode
...
///Field `GPIOALPEN` writer - GPIOA peripheral clock enable in low-power mode
...
///Field `GPIOBLPEN` reader - GPIOB peripheral clock enable in low-power mode
pub use GPIOALPEN_R as GPIOBLPEN_R;
///Field `GPIOCLPEN` reader - GPIOC peripheral clock enable in low-power mode
pub use GPIOALPEN_R as GPIOCLPEN_R;
///Field `GPIODLPEN` reader - GPIOD peripheral clock enable in low-power mode
pub use GPIOALPEN_R as GPIODLPEN_R;
///Field `GPIOELPEN` reader - GPIOE peripheral clock enable in low-power mode
pub use GPIOALPEN_R as GPIOELPEN_R;
///Field `GPIOFLPEN` reader - GPIOF peripheral clock enable in low-power mode
pub use GPIOALPEN_R as GPIOFLPEN_R;
///Field `GPIOGLPEN` reader - GPIOG peripheral clock enable in low-power mode
pub use GPIOALPEN_R as GPIOGLPEN_R;
///Field `GPIOHLPEN` reader - GPIOH peripheral clock enable in low-power mode
pub use GPIOALPEN_R as GPIOHLPEN_R;
///Field `GPIOMLPEN` reader - GPIOM peripheral clock enable in low-power mode
pub use GPIOALPEN_R as GPIOMLPEN_R;
///Field `GPIONLPEN` reader - GPION peripheral clock enable in low-power mode
pub use GPIOALPEN_R as GPIONLPEN_R;
///Field `GPIOOLPEN` reader - GPIOO peripheral clock enable in low-power mode
pub use GPIOALPEN_R as GPIOOLPEN_R;
///Field `GPIOPLPEN` reader - GPIOP peripheral clock enable in low-power mode
pub use GPIOALPEN_R as GPIOPLPEN_R;
///Field `CRCLPEN` reader - CRC clock enable in low-power mode
pub use GPIOALPEN_R as CRCLPEN_R;
///Field `BKPRAMLPEN` reader - Backup RAM clock enable in low-power mode
pub use GPIOALPEN_R as BKPRAMLPEN_R;
///Field `GPIOBLPEN` writer - GPIOB peripheral clock enable in low-power mode
pub use GPIOALPEN_W as GPIOBLPEN_W;
///Field `GPIOCLPEN` writer - GPIOC peripheral clock enable in low-power mode
pub use GPIOALPEN_W as GPIOCLPEN_W;
///Field `GPIODLPEN` writer - GPIOD peripheral clock enable in low-power mode
pub use GPIOALPEN_W as GPIODLPEN_W;
///Field `GPIOELPEN` writer - GPIOE peripheral clock enable in low-power mode
pub use GPIOALPEN_W as GPIOELPEN_W;
///Field `GPIOFLPEN` writer - GPIOF peripheral clock enable in low-power mode
pub use GPIOALPEN_W as GPIOFLPEN_W;
///Field `GPIOGLPEN` writer - GPIOG peripheral clock enable in low-power mode
pub use GPIOALPEN_W as GPIOGLPEN_W;
///Field `GPIOHLPEN` writer - GPIOH peripheral clock enable in low-power mode
pub use GPIOALPEN_W as GPIOHLPEN_W;
///Field `GPIOMLPEN` writer - GPIOM peripheral clock enable in low-power mode
pub use GPIOALPEN_W as GPIOMLPEN_W;
///Field `GPIONLPEN` writer - GPION peripheral clock enable in low-power mode
pub use GPIOALPEN_W as GPIONLPEN_W;
///Field `GPIOOLPEN` writer - GPIOO peripheral clock enable in low-power mode
pub use GPIOALPEN_W as GPIOOLPEN_W;
///Field `GPIOPLPEN` writer - GPIOP peripheral clock enable in low-power mode
pub use GPIOALPEN_W as GPIOPLPEN_W;
///Field `CRCLPEN` writer - CRC clock enable in low-power mode
pub use GPIOALPEN_W as CRCLPEN_W;
///Field `BKPRAMLPEN` writer - Backup RAM clock enable in low-power mode
pub use GPIOALPEN_W as BKPRAMLPEN_W;
impl R {
    ///Bit 0 - GPIOA peripheral clock enable in low-power mode
    #[inline(always)]
    pub fn gpioalpen(&self) -> GPIOALPEN_R {
        GPIOALPEN_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - GPIOB peripheral clock enable in low-power mode
    #[inline(always)]
    pub fn gpioblpen(&self) -> GPIOBLPEN_R {
        GPIOBLPEN_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - GPIOC peripheral clock enable in low-power mode
    #[inline(always)]
    pub fn gpioclpen(&self) -> GPIOCLPEN_R {
        GPIOCLPEN_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - GPIOD peripheral clock enable in low-power mode
    #[inline(always)]
    pub fn gpiodlpen(&self) -> GPIODLPEN_R {
        GPIODLPEN_R::new(((self.bits >> 3) & 1) != 0)
    }
    ///Bit 4 - GPIOE peripheral clock enable in low-power mode
    #[inline(always)]
    pub fn gpioelpen(&self) -> GPIOELPEN_R {
        GPIOELPEN_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 5 - GPIOF peripheral clock enable in low-power mode
    #[inline(always)]
    pub fn gpioflpen(&self) -> GPIOFLPEN_R {
        GPIOFLPEN_R::new(((self.bits >> 5) & 1) != 0)
    }
    ///Bit 6 - GPIOG peripheral clock enable in low-power mode
    #[inline(always)]
    pub fn gpioglpen(&self) -> GPIOGLPEN_R {
        GPIOGLPEN_R::new(((self.bits >> 6) & 1) != 0)
    }
    ///Bit 7 - GPIOH peripheral clock enable in low-power mode
    #[inline(always)]
    pub fn gpiohlpen(&self) -> GPIOHLPEN_R {
        GPIOHLPEN_R::new(((self.bits >> 7) & 1) != 0)
    }
    ///Bit 12 - GPIOM peripheral clock enable in low-power mode
    #[inline(always)]
    pub fn gpiomlpen(&self) -> GPIOMLPEN_R {
        GPIOMLPEN_R::new(((self.bits >> 12) & 1) != 0)
    }
    ///Bit 13 - GPION peripheral clock enable in low-power mode
    #[inline(always)]
    pub fn gpionlpen(&self) -> GPIONLPEN_R {
        GPIONLPEN_R::new(((self.bits >> 13) & 1) != 0)
    }
    ///Bit 14 - GPIOO peripheral clock enable in low-power mode
    #[inline(always)]
    pub fn gpioolpen(&self) -> GPIOOLPEN_R {
        GPIOOLPEN_R::new(((self.bits >> 14) & 1) != 0)
    }
    ///Bit 15 - GPIOP peripheral clock enable in low-power mode
    #[inline(always)]
    pub fn gpioplpen(&self) -> GPIOPLPEN_R {
        GPIOPLPEN_R::new(((self.bits >> 15) & 1) != 0)
    }
    ///Bit 19 - CRC clock enable in low-power mode
    #[inline(always)]
    pub fn crclpen(&self) -> CRCLPEN_R {
        CRCLPEN_R::new(((self.bits >> 19) & 1) != 0)
    }
    ///Bit 28 - Backup RAM clock enable in low-power mode
    #[inline(always)]
...
impl W {
    ...
    ///Bit 12 - GPIOM peripheral clock enable in low-power mode
    #[inline(always)]
    pub fn gpiomlpen(&mut self) -> GPIOMLPEN_W<'_, AHB4LPENRrs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#RCC:AHB4LPENR)*/
