...
///Field `CMP2OKIE` reader - Compare register 2 update OK interrupt enable Note: If LPTIM does not implement at least 2 channels this bit is reserved. Refer to Section 26.3.
pub type CMP2OKIE_R = crate::BitReader;
///Field `CMP2OKIE` writer - Compare register 2 update OK interrupt enable Note: If LPTIM does not implement at least 2 channels this bit is reserved. Refer to Section 26.3.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7R.html#LPTIM1:DIER_OUTPUT)*/
