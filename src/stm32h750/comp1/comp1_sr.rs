///Register `COMP1_SR` reader
pub type R = crate::R<COMP1_SRrs>;
...
You can [`read`](crate::Reg::read) this register and get [`comp1_sr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H750.html#COMP1:COMP1_SR)*/
pub struct COMP1_SRrs;
impl crate::RegisterSpec for COMP1_SRrs {
    type Ux = u32;
}
///`read()` method returns [`comp1_sr::R`](R) reader structure
impl crate::Readable for COMP1_SRrs {}
///`reset()` method sets COMP1_SR to value 0
impl crate::Resettable for COMP1_SRrs {}
