...
pub use HTIF0_A as HTIF7_A;
#[doc = "Half transfer (HT) flag for channel x"]
pub use HTIF0_A as HTIF6_A;
#[doc = "Half transfer (HT) flag for channel x"]
pub use HTIF0_A as HTIF5_A;
#[doc = "Half transfer (HT) flag for channel x"]
pub use HTIF0_A as HTIF4_A;
#[doc = "Half transfer (HT) flag for channel x"]
...
pub use TCIF0_A as TCIF7_A;
#[doc = "Transfer complete (TC) flag for channel x"]
pub use TCIF0_A as TCIF6_A;
#[doc = "Transfer complete (TC) flag for channel x"]
pub use TCIF0_A as TCIF5_A;
#[doc = "Transfer complete (TC) flag for channel x"]
pub use TCIF0_A as TCIF4_A;
#[doc = "Transfer complete (TC) flag for channel x"]
...
pub use TEIF0_A as TEIF7_A;
#[doc = "Transfer error (TE) flag for channel x"]
pub use TEIF0_A as TEIF6_A;
#[doc = "Transfer error (TE) flag for channel x"]
pub use TEIF0_A as TEIF5_A;
#[doc = "Transfer error (TE) flag for channel x"]
pub use TEIF0_A as TEIF4_A;
#[doc = "Transfer error (TE) flag for channel x"]
