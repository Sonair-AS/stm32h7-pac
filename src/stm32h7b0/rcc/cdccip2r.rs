///Register `CDCCIP2R` reader
pub type R = crate::R<CDCCIP2Rrs>;
///Register `CDCCIP2R` writer
...
///Field `USART234578SEL` reader - USART2/3, UART4,5, 7 and 8 (APB1) kernel clock source selection Set and reset by software. others: reserved, the kernel clock is disabled
...
///Field `USART234578SEL` writer - USART2/3, UART4,5, 7 and 8 (APB1) kernel clock source selection Set and reset by software. others: reserved, the kernel clock is disabled
...
///Field `USART16910SEL` reader - USART1, 6, 9 and 10 kernel clock source selection Set and reset by software. others: reserved, the kernel clock is disabled
...
///Field `USART16910SEL` writer - USART1, 6, 9 and 10 kernel clock source selection Set and reset by software. others: reserved, the kernel clock is disabled
...
///Field `RNGSEL` reader - RNG kernel clock source selection Set and reset by software.
...
///Field `RNGSEL` writer - RNG kernel clock source selection Set and reset by software.
...
///Field `I2C123SEL` reader - I2C1,2,3 kernel clock source selection Set and reset by software.
...
///Field `I2C123SEL` writer - I2C1,2,3 kernel clock source selection Set and reset by software.
...
///Field `USBSEL` reader - USBOTG 1 and 2 kernel clock source selection Set and reset by software.
...
///Field `USBSEL` writer - USBOTG 1 and 2 kernel clock source selection Set and reset by software.
...
impl W {
    ///Bits 0:2 - USART2/3, UART4,5, 7 and 8 (APB1) kernel clock source selection Set and reset by software. others: reserved, the kernel clock is disabled
    #[inline(always)]
    pub fn usart234578sel(&mut self) -> USART234578SEL_W<'_, CDCCIP2Rrs> {
        USART234578SEL_W::new(self, 0)
    }
    ///Bits 3:5 - USART1, 6, 9 and 10 kernel clock source selection Set and reset by software. others: reserved, the kernel clock is disabled
    #[inline(always)]
    pub fn usart16910sel(&mut self) -> USART16910SEL_W<'_, CDCCIP2Rrs> {
        USART16910SEL_W::new(self, 3)
    }
    ///Bits 8:9 - RNG kernel clock source selection Set and reset by software.
    #[inline(always)]
    pub fn rngsel(&mut self) -> RNGSEL_W<'_, CDCCIP2Rrs> {
        RNGSEL_W::new(self, 8)
    }
    ///Bits 12:13 - I2C1,2,3 kernel clock source selection Set and reset by software.
    #[inline(always)]
    pub fn i2c123sel(&mut self) -> I2C123SEL_W<'_, CDCCIP2Rrs> {
        I2C123SEL_W::new(self, 12)
    }
    ///Bits 20:21 - USBOTG 1 and 2 kernel clock source selection Set and reset by software.
    #[inline(always)]
    pub fn usbsel(&mut self) -> USBSEL_W<'_, CDCCIP2Rrs> {
        USBSEL_W::new(self, 20)
    }
    ///Bits 22:23 - HDMI-CEC kernel clock source selection Set and reset by software.
    #[inline(always)]
    pub fn cecsel(&mut self) -> CECSEL_W<'_, CDCCIP2Rrs> {
        CECSEL_W::new(self, 22)
    }
    ///Bits 28:30 - LPTIM1 kernel clock source selection Set and reset by software. others: reserved, the kernel clock is disabled
    #[inline(always)]
    pub fn lptim1sel(&mut self) -> LPTIM1SEL_W<'_, CDCCIP2Rrs> {
        LPTIM1SEL_W::new(self, 28)
    }
}
/**RCC CPU domain kernel clock configuration register

You can [`read`](crate::Reg::read) this register and get [`cdccip2r::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cdccip2r::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
...
///`read()` method returns [`cdccip2r::R`](R) reader structure
impl crate::Readable for CDCCIP2Rrs {}
///`write(|w| ..)` method takes [`cdccip2r::W`](W) writer structure
impl crate::Writable for CDCCIP2Rrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CDCCIP2R to value 0
