...
/**The bit indicates the number of correct codes. For debug purposes only.
...
///Field `RXSOP3OF4` reader - The bit indicates the number of correct codes. For debug purposes only.
