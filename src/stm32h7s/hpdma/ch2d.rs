...
impl CH2D {
    ///0x00 - HPDMA channel 12 linked-list base address register
    #[inline(always)]
    pub const fn lbar(&self) -> &LBAR {
        &self.lbar
    }
    ///0x0c - HPDMA channel 12 flag clear register
    #[inline(always)]
    pub const fn fcr(&self) -> &FCR {
        &self.fcr
    }
    ///0x10 - HPDMA channel 12 status register
    #[inline(always)]
    pub const fn sr(&self) -> &SR {
        &self.sr
    }
    ///0x14 - HPDMA channel 12 control register
    #[inline(always)]
    pub const fn cr(&self) -> &CR {
        &self.cr
    }
    ///0x40 - HPDMA channel 12 transfer register 1
    #[inline(always)]
    pub const fn tr1(&self) -> &TR1 {
        &self.tr1
    }
    ///0x44 - HPDMA channel 12 transfer register 2
    #[inline(always)]
    pub const fn tr2(&self) -> &TR2 {
        &self.tr2
    }
    ///0x48 - HPDMA channel 12 alternate block register 1
    #[inline(always)]
    pub const fn br1(&self) -> &BR1 {
        &self.br1
    }
    ///0x4c - HPDMA channel 12 source address register
    #[inline(always)]
    pub const fn sar(&self) -> &SAR {
        &self.sar
    }
    ///0x50 - HPDMA channel 12 destination address register
    #[inline(always)]
    pub const fn dar(&self) -> &DAR {
        &self.dar
    }
    ///0x54 - HPDMA channel 12 transfer register 3
    #[inline(always)]
    pub const fn tr3(&self) -> &TR3 {
        &self.tr3
    }
    ///0x58 - HPDMA channel 12 block register 2
    #[inline(always)]
    pub const fn br2(&self) -> &BR2 {
        &self.br2
    }
    ///0x7c - HPDMA channel 12 alternate linked-list address register
    #[inline(always)]
    pub const fn llr(&self) -> &LLR {
        &self.llr
    }
}
pub use crate::stm32h7s::hpdma::ch::cr;
pub use crate::stm32h7s::hpdma::ch::fcr;
pub use crate::stm32h7s::hpdma::ch::lbar;
pub use crate::stm32h7s::hpdma::ch::sr;
pub use crate::stm32h7s::hpdma::ch::tr1;
pub use crate::stm32h7s::hpdma::ch::tr2;
pub use crate::stm32h7s::hpdma::ch::CR;
pub use crate::stm32h7s::hpdma::ch::FCR;
pub use crate::stm32h7s::hpdma::ch::LBAR;
pub use crate::stm32h7s::hpdma::ch::SR;
pub use crate::stm32h7s::hpdma::ch::TR1;
pub use crate::stm32h7s::hpdma::ch::TR2;
/**BR1 (rw) register accessor: HPDMA channel 12 alternate block register 1
...
pub mod br1;
pub use crate::stm32h7s::hpdma::ch::dar;
pub use crate::stm32h7s::hpdma::ch::sar;
pub use crate::stm32h7s::hpdma::ch::DAR;
pub use crate::stm32h7s::hpdma::ch::SAR;
/**TR3 (rw) register accessor: HPDMA channel 12 transfer register 3
...
pub mod tr3;
/**BR2 (rw) register accessor: HPDMA channel 12 block register 2
...
pub mod br2;
/**LLR (rw) register accessor: HPDMA channel 12 alternate linked-list address register
