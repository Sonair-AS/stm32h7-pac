...
///Field `PROT_AREA_START` reader - Bank 1 lowest PCROP protected address configuration
pub type PROT_AREA_START_R = crate::FieldReader<u16>;
///Field `PROT_AREA_START` writer - Bank 1 lowest PCROP protected address configuration
pub type PROT_AREA_START_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
///Field `PROT_AREA_END` reader - Bank 1 highest PCROP protected address configuration
pub type PROT_AREA_END_R = crate::FieldReader<u16>;
///Field `PROT_AREA_END` writer - Bank 1 highest PCROP protected address configuration
...
impl R {
    ///Bits 0:11 - Bank 1 lowest PCROP protected address configuration
    #[inline(always)]
    pub fn prot_area_start(&self) -> PROT_AREA_START_R {
        PROT_AREA_START_R::new((self.bits & 0x0fff) as u16)
    }
    ///Bits 16:27 - Bank 1 highest PCROP protected address configuration
    #[inline(always)]
