...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B0.html#PWR:CR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B0.html#PWR:CSR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B0.html#PWR:CPUCR)
...
pub mod cpucr;
/**SRDCR (rw) register accessor: This register allows controlling D3 domain power.Following reset VOSRDY will be read 1 by software

You can [`read`](crate::Reg::read) this register and get [`srdcr::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`srdcr::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B0.html#PWR:SRDCR)

For information about available fields see [`mod@srdcr`] module*/
pub type SRDCR = crate::Reg<srdcr::SRDCRrs>;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B0.html#PWR:WKUPCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7B0.html#PWR:WKUPFR)
