...
///Field `CPERF` reader - clear the preamble error flag Writing 1 to this bit clears the PERF flag (in MDIOS_SR).
pub type CPERF_R = crate::BitReader;
///Field `CPERF` writer - clear the preamble error flag Writing 1 to this bit clears the PERF flag (in MDIOS_SR).
pub type CPERF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CSERF` reader - clear the start error flag Writing 1 to this bit clears the SERF flag (in MDIOS_SR). When DPC = 1 (MDIOS_CR\[7\]), the SERF flag must be cleared only when there is not a frame already in progress.
pub type CSERF_R = crate::BitReader;
///Field `CSERF` writer - clear the start error flag Writing 1 to this bit clears the SERF flag (in MDIOS_SR). When DPC = 1 (MDIOS_CR\[7\]), the SERF flag must be cleared only when there is not a frame already in progress.
pub type CSERF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CTERF` reader - clear the turnaround error flag Writing 1 to this bit clears the TERF flag (in MDIOS_SR). When DPC = 1 (MDIOS_CR\[7\]), the TERF flag must be cleared only when there is not a frame already in progress.
pub type CTERF_R = crate::BitReader;
///Field `CTERF` writer - clear the turnaround error flag Writing 1 to this bit clears the TERF flag (in MDIOS_SR). When DPC = 1 (MDIOS_CR\[7\]), the TERF flag must be cleared only when there is not a frame already in progress.
