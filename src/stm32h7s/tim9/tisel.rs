...
///Field `TI2SEL` reader - selects tim_ti2_in\[15:0\] input ... Refer to Table 657: Interconnect to the tim_ti2 input multiplexer for interconnects list.
pub type TI2SEL_R = crate::FieldReader;
///Field `TI2SEL` writer - selects tim_ti2_in\[15:0\] input ... Refer to Table 657: Interconnect to the tim_ti2 input multiplexer for interconnects list.
