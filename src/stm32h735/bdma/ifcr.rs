...
pub use CGIF0_AW as CGIF7_AW;
#[doc = "Global interrupt flag clear for channel x"]
pub use CGIF0_AW as CGIF6_AW;
#[doc = "Global interrupt flag clear for channel x"]
pub use CGIF0_AW as CGIF5_AW;
#[doc = "Global interrupt flag clear for channel x"]
pub use CGIF0_AW as CGIF4_AW;
#[doc = "Global interrupt flag clear for channel x"]
pub use CGIF0_AW as CGIF3_AW;
#[doc = "Global interrupt flag clear for channel x"]
pub use CGIF0_AW as CGIF2_AW;
#[doc = "Global interrupt flag clear for channel x"]
pub use CGIF0_AW as CGIF1_AW;
...
pub use CHTIF0_AW as CHTIF7_AW;
#[doc = "Half transfer (HT) flag clear for channel x"]
pub use CHTIF0_AW as CHTIF6_AW;
#[doc = "Half transfer (HT) flag clear for channel x"]
pub use CHTIF0_AW as CHTIF5_AW;
#[doc = "Half transfer (HT) flag clear for channel x"]
pub use CHTIF0_AW as CHTIF4_AW;
#[doc = "Half transfer (HT) flag clear for channel x"]
...
pub use CTCIF0_AW as CTCIF7_AW;
#[doc = "Transfer complete (TC) flag clear for channel x"]
pub use CTCIF0_AW as CTCIF6_AW;
#[doc = "Transfer complete (TC) flag clear for channel x"]
pub use CTCIF0_AW as CTCIF5_AW;
#[doc = "Transfer complete (TC) flag clear for channel x"]
pub use CTCIF0_AW as CTCIF4_AW;
#[doc = "Transfer complete (TC) flag clear for channel x"]
...
pub use CTEIF0_AW as CTEIF7_AW;
#[doc = "Transfer error (TE) flag clear for channel x"]
pub use CTEIF0_AW as CTEIF6_AW;
#[doc = "Transfer error (TE) flag clear for channel x"]
pub use CTEIF0_AW as CTEIF5_AW;
#[doc = "Transfer error (TE) flag clear for channel x"]
pub use CTEIF0_AW as CTEIF4_AW;
#[doc = "Transfer error (TE) flag clear for channel x"]
