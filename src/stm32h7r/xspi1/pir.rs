...
///Field `INTERVAL` reader - Polling interval Number of CLK cycle between a read during the automatic status-polling phases
pub type INTERVAL_R = crate::FieldReader<u16>;
///Field `INTERVAL` writer - Polling interval Number of CLK cycle between a read during the automatic status-polling phases
