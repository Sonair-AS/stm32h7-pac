...
///Field `PPSEN0` reader - Flexible PPS Output Mode Enable When this bit is set, PPSCTRL\[3:0\] function as PPSCMD. When this bit is reset, PPSCTRL\[3:0\] function as PPSCTRL (Fixed PPS mode).
pub type PPSEN0_R = crate::BitReader;
///Field `PPSEN0` writer - Flexible PPS Output Mode Enable When this bit is set, PPSCTRL\[3:0\] function as PPSCMD. When this bit is reset, PPSCTRL\[3:0\] function as PPSCTRL (Fixed PPS mode).
pub type PPSEN0_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TRGTMODSEL0` reader - Target Time Register Mode for PPS Output This field indicates the Target Time registers ((ETH_MACPPSTTSR) and ) mode for PPS output signal:
pub type TRGTMODSEL0_R = crate::FieldReader;
///Field `TRGTMODSEL0` writer - Target Time Register Mode for PPS Output This field indicates the Target Time registers ((ETH_MACPPSTTSR) and ) mode for PPS output signal:
...
impl R {
    ...
    ///Bit 4 - Flexible PPS Output Mode Enable When this bit is set, PPSCTRL\[3:0\] function as PPSCMD. When this bit is reset, PPSCTRL\[3:0\] function as PPSCTRL (Fixed PPS mode).
    #[inline(always)]
    pub fn ppsen0(&self) -> PPSEN0_R {
        PPSEN0_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bits 5:6 - Target Time Register Mode for PPS Output This field indicates the Target Time registers ((ETH_MACPPSTTSR) and ) mode for PPS output signal:
    #[inline(always)]
