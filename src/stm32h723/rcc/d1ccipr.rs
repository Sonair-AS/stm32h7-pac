...
///Field `OCTOSPISEL` reader - QUADSPI kernel clock source selection
pub use FMCSEL_R as OCTOSPISEL_R;
///Field `OCTOSPISEL` writer - QUADSPI kernel clock source selection
...
impl W {
    ...
    ///Bits 4:5 - QUADSPI kernel clock source selection
    #[inline(always)]
    pub fn octospisel(&mut self) -> OCTOSPISEL_W<'_, D1CCIPRrs> {
