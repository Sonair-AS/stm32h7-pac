...
///Field `USB2OTGHSLPEN` reader - USB2OTG peripheral clock enable during CSleep mode
pub use DMA1LPEN_R as USB2OTGHSLPEN_R;
///Field `USB2OTGHSULPILPEN` reader - USB_PHY2 clocks enable during CSleep mode
...
///Field `USB2OTGHSLPEN` writer - USB2OTG peripheral clock enable during CSleep mode
pub use DMA1LPEN_W as USB2OTGHSLPEN_W;
///Field `USB2OTGHSULPILPEN` writer - USB_PHY2 clocks enable during CSleep mode
...
impl R {
    ...
    pub fn usb2otghslpen(&self) -> USB2OTGHSLPEN_R {
        USB2OTGHSLPEN_R::new(((self.bits >> 27) & 1) != 0)
    }
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("AHB1LPENR")
            ...
            .field("usb2otghslpen", &self.usb2otghslpen())
            .field("usb2otghsulpilpen", &self.usb2otghsulpilpen())
            .finish()
    }
}
impl W {
    ...
    ///Bit 27 - USB2OTG peripheral clock enable during CSleep mode
    #[inline(always)]
    pub fn usb2otghslpen(&mut self) -> USB2OTGHSLPEN_W<'_, AHB1LPENRrs> {
        USB2OTGHSLPEN_W::new(self, 27)
    }
    ///Bit 28 - USB_PHY2 clocks enable during CSleep mode
    #[inline(always)]
    pub fn usb2otghsulpilpen(&mut self) -> USB2OTGHSULPILPEN_W<'_, AHB1LPENRrs> {
        USB2OTGHSULPILPEN_W::new(self, 28)
    }
}
