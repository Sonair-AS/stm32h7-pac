...
impl RegisterBlock {
    ...
    ///0x38 - DMA2D output color register
    #[inline(always)]
    pub const fn ocolr_argb8888(&self) -> &OCOLR_ARGB8888 {
        unsafe { &*core::ptr::from_ref(self).cast::<u8>().add(56).cast() }
    }
    ...
    ///0x400..0x800 - DMA2D foreground CLUT
    #[inline(always)]
    pub const fn fgclut(&self, n: usize) -> &FGCLUT {
        &self.fgclut[n]
    }
    ///Iterator for array of:
    ///0x400..0x800 - DMA2D foreground CLUT
    #[inline(always)]
    pub fn fgclut_iter(&self) -> impl Iterator<Item = &FGCLUT> {
        self.fgclut.iter()
    }
    ///0x800..0xc00 - DMA2D background CLUT
    #[inline(always)]
    pub const fn bgclut(&self, n: usize) -> &BGCLUT {
        &self.bgclut[n]
    }
    ///Iterator for array of:
    ///0x800..0xc00 - DMA2D background CLUT
    #[inline(always)]
    pub fn bgclut_iter(&self) -> impl Iterator<Item = &BGCLUT> {
        self.bgclut.iter()
    }
}
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#DMA2D:ISR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#DMA2D:FGMAR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#DMA2D:FGOR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#DMA2D:BGMAR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#DMA2D:BGOR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#DMA2D:BGPFCCR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#DMA2D:BGCMAR)
...
pub mod opfccr;
/**OCOLR_ARGB8888 (rw) register accessor: DMA2D output color register

You can [`read`](crate::Reg::read) this register and get [`ocolr_argb8888::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ocolr_argb8888::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#DMA2D:OCOLR_ARGB8888)

For information about available fields see [`mod@ocolr_argb8888`] module*/
pub type OCOLR_ARGB8888 = crate::Reg<ocolr_argb8888::OCOLR_ARGB8888rs>;
///DMA2D output color register
pub mod ocolr_argb8888;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#DMA2D:OCOLR_RGB565)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#DMA2D:OCOLR_ARGB1555)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#DMA2D:NLR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#DMA2D:LWR)
...
pub mod amtcr;
/**FGCLUT (rw) register accessor: DMA2D foreground CLUT
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#DMA2D:FGCLUT[0])
...
pub mod fgclut;
/**BGCLUT (rw) register accessor: DMA2D background CLUT
