...
///Field `MACRWKPFR` reader - Remote wakeup packet filter Refer to , and for details on register content and programming sequence.
pub type MACRWKPFR_R = crate::FieldReader<u32>;
///Field `MACRWKPFR` writer - Remote wakeup packet filter Refer to , and for details on register content and programming sequence.
pub type MACRWKPFR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Remote wakeup packet filter Refer to , and for details on register content and programming sequence.
    #[inline(always)]
