...
///Field `FRAME` reader - frame reload value Reload value for the relative frame counter 1.
pub type FRAME_R = crate::FieldReader<u16>;
///Field `FRAME` writer - frame reload value Reload value for the relative frame counter 1.
