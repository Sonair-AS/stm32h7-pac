...
///Field `TAMPPRIV` reader - Tamper privilege protection (excluding backup registers) Note: Refer to Section 46.3.6: TAMP privilege protection modes for details on the read protection.
pub type TAMPPRIV_R = crate::BitReader;
///Field `TAMPPRIV` writer - Tamper privilege protection (excluding backup registers) Note: Refer to Section 46.3.6: TAMP privilege protection modes for details on the read protection.
