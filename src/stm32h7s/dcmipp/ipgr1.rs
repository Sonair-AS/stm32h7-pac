...
///Field `QOS_MODE` reader - Quality of service Set of functions enabling to build and configure an architecture able to meet bandwidth and latency requirements.
pub type QOS_MODE_R = crate::BitReader;
///Field `QOS_MODE` writer - Quality of service Set of functions enabling to build and configure an architecture able to meet bandwidth and latency requirements.
