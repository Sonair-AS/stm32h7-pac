...
pub use DCMILPEN_A as SRAM1LPEN_A;
#[doc = "SRAM2 Clock Enable During CSleep Mode"]
pub use DCMILPEN_A as SRAM2LPEN_A;
#[doc = "FMAC enable during CSleep Mode"]
pub use DCMILPEN_A as FMACLPEN_A;
#[doc = "CORDIC enable during CSleep Mode"]
pub use DCMILPEN_A as CORDICLPEN_A;
