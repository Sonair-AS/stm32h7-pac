///Register `MACPPSCRALTERNATE` reader
pub type R = crate::R<MACPPSCRALTERNATErs>;
///Register `MACPPSCRALTERNATE` writer
pub type W = crate::W<MACPPSCRALTERNATErs>;
...
///Field `PPSEN0` reader - Flexible PPS Output Mode Enable When this bit is set, Bits\[3:0\] function as PPSCMD. When this bit is reset, Bits\[3:0\] function as PPSCTRL (Fixed PPS mode).
pub type PPSEN0_R = crate::BitReader;
///Field `PPSEN0` writer - Flexible PPS Output Mode Enable When this bit is set, Bits\[3:0\] function as PPSCMD. When this bit is reset, Bits\[3:0\] function as PPSCTRL (Fixed PPS mode).
...
impl R {
    ...
    ///Bit 4 - Flexible PPS Output Mode Enable When this bit is set, Bits\[3:0\] function as PPSCMD. When this bit is reset, Bits\[3:0\] function as PPSCTRL (Fixed PPS mode).
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MACPPSCRALTERNATE")
...
impl W {
    ///Bits 0:3 - Flexible PPS Output (eth_ptp_pps_out) Control Programming these bits with a non-zero value instructs the MAC to initiate an event. When the command is transferred or synchronized to the PTP clock domain, these bits get cleared automatically. The software should ensure that these bits are programmed only when they are all zero. The following list describes the values of PPSCMD0: This command generates single pulse rising at the start point defined in Target Time Registers (register 455 and 456) and of a duration defined in the PPS Width Register. This command generates the train of pulses rising at the start point defined in the Target Time Registers and of a duration defined in the PPS Width Register and repeated at interval defined in the PPS Interval Register. By default, the PPS pulse train is free-running unless stopped by the 'Stop Pulse train at time' or 'Stop Pulse Train immediately' commands. This command cancels the START Single Pulse and START Pulse Train commands if the system time has not crossed the programmed start time. This command stops the train of pulses initiated by the START Pulse Train command (PPSCMD = 0010) after the time programmed in the Target Time registers elapses. This command immediately stops the train of pulses initiated by the START Pulse Train command (PPSCMD = 0010). This command cancels the STOP pulse train at time command if the programmed stop time has not elapsed. The PPS pulse train becomes free-running on the successful execution of this command.
    #[inline(always)]
    pub fn ppscmd(&mut self) -> PPSCMD_W<'_, MACPPSCRALTERNATErs> {
        PPSCMD_W::new(self, 0)
    }
    ///Bit 4 - Flexible PPS Output Mode Enable When this bit is set, Bits\[3:0\] function as PPSCMD. When this bit is reset, Bits\[3:0\] function as PPSCTRL (Fixed PPS mode).
    #[inline(always)]
    pub fn ppsen0(&mut self) -> PPSEN0_W<'_, MACPPSCRALTERNATErs> {
        PPSEN0_W::new(self, 4)
    }
    ///Bits 5:6 - Target Time Register Mode for PPS Output This field indicates the Target Time registers (MAC registers 96 and 97) mode for PPS output signal:
    #[inline(always)]
    pub fn trgtmodsel0(&mut self) -> TRGTMODSEL0_W<'_, MACPPSCRALTERNATErs> {
        TRGTMODSEL0_W::new(self, 5)
    }
}
/**ETH_MACPPSCRALTERNATE

You can [`read`](crate::Reg::read) this register and get [`macppscralternate::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`macppscralternate::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H750.html#ETH:MACPPSCRALTERNATE)*/
pub struct MACPPSCRALTERNATErs;
impl crate::RegisterSpec for MACPPSCRALTERNATErs {
    type Ux = u32;
}
///`read()` method returns [`macppscralternate::R`](R) reader structure
impl crate::Readable for MACPPSCRALTERNATErs {}
///`write(|w| ..)` method takes [`macppscralternate::W`](W) writer structure
impl crate::Writable for MACPPSCRALTERNATErs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets MACPPSCRALTERNATE to value 0
impl crate::Resettable for MACPPSCRALTERNATErs {}
