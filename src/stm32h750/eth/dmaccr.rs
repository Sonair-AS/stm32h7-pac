...
///Field `PBLX8` reader - 8xPBL mode When this bit is set, the PBL value programmed in Bits\[21:16\] in register (ETH_DMACTXCR) is multiplied eight times. Therefore, the DMA transfers the data in 8, 16, 32, 64, 128, and 256 beats depending on the PBL value.
pub type PBLX8_R = crate::BitReader;
///Field `PBLX8` writer - 8xPBL mode When this bit is set, the PBL value programmed in Bits\[21:16\] in register (ETH_DMACTXCR) is multiplied eight times. Therefore, the DMA transfers the data in 8, 16, 32, 64, 128, and 256 beats depending on the PBL value.
...
impl R {
    ...
    ///Bit 16 - 8xPBL mode When this bit is set, the PBL value programmed in Bits\[21:16\] in register (ETH_DMACTXCR) is multiplied eight times. Therefore, the DMA transfers the data in 8, 16, 32, 64, 128, and 256 beats depending on the PBL value.
    #[inline(always)]
