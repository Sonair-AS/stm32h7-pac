...
///Field `MR0` reader - CPU interrupt mask on configurable event input x
pub type MR0_R = crate::BitReader;
///Field `MR0` writer - CPU interrupt mask on configurable event input x
pub type MR0_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MR1` reader - CPU interrupt mask on configurable event input x
pub type MR1_R = crate::BitReader;
///Field `MR1` writer - CPU interrupt mask on configurable event input x
pub type MR1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MR2` reader - CPU interrupt mask on configurable event input x
pub type MR2_R = crate::BitReader;
///Field `MR2` writer - CPU interrupt mask on configurable event input x
pub type MR2_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MR3` reader - CPU interrupt mask on configurable event input x
pub type MR3_R = crate::BitReader;
///Field `MR3` writer - CPU interrupt mask on configurable event input x
pub type MR3_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MR4` reader - CPU interrupt mask on configurable event input x
pub type MR4_R = crate::BitReader;
///Field `MR4` writer - CPU interrupt mask on configurable event input x
pub type MR4_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MR5` reader - CPU interrupt mask on configurable event input x
pub type MR5_R = crate::BitReader;
///Field `MR5` writer - CPU interrupt mask on configurable event input x
pub type MR5_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MR6` reader - CPU interrupt mask on configurable event input x
pub type MR6_R = crate::BitReader;
///Field `MR6` writer - CPU interrupt mask on configurable event input x
pub type MR6_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MR7` reader - CPU interrupt mask on configurable event input x
pub type MR7_R = crate::BitReader;
///Field `MR7` writer - CPU interrupt mask on configurable event input x
pub type MR7_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MR8` reader - CPU interrupt mask on configurable event input x
pub type MR8_R = crate::BitReader;
///Field `MR8` writer - CPU interrupt mask on configurable event input x
pub type MR8_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MR9` reader - CPU interrupt mask on configurable event input x
pub type MR9_R = crate::BitReader;
///Field `MR9` writer - CPU interrupt mask on configurable event input x
pub type MR9_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MR10` reader - CPU interrupt mask on configurable event input x
pub type MR10_R = crate::BitReader;
///Field `MR10` writer - CPU interrupt mask on configurable event input x
pub type MR10_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MR11` reader - CPU interrupt mask on configurable event input x
pub type MR11_R = crate::BitReader;
///Field `MR11` writer - CPU interrupt mask on configurable event input x
pub type MR11_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MR12` reader - CPU interrupt mask on configurable event input x
pub type MR12_R = crate::BitReader;
///Field `MR12` writer - CPU interrupt mask on configurable event input x
pub type MR12_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MR13` reader - CPU interrupt mask on configurable event input x
pub type MR13_R = crate::BitReader;
///Field `MR13` writer - CPU interrupt mask on configurable event input x
pub type MR13_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MR14` reader - CPU interrupt mask on configurable event input x
pub type MR14_R = crate::BitReader;
///Field `MR14` writer - CPU interrupt mask on configurable event input x
pub type MR14_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MR15` reader - CPU interrupt mask on configurable event input x
pub type MR15_R = crate::BitReader;
///Field `MR15` writer - CPU interrupt mask on configurable event input x
pub type MR15_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MR16` reader - CPU interrupt mask on configurable event input x
pub type MR16_R = crate::BitReader;
///Field `MR16` writer - CPU interrupt mask on configurable event input x
pub type MR16_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MR17` reader - CPU interrupt mask on configurable event input x
pub type MR17_R = crate::BitReader;
///Field `MR17` writer - CPU interrupt mask on configurable event input x
pub type MR17_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MR18` reader - CPU interrupt mask on configurable event input x
pub type MR18_R = crate::BitReader;
///Field `MR18` writer - CPU interrupt mask on configurable event input x
pub type MR18_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MR19` reader - CPU interrupt mask on configurable event input x
pub type MR19_R = crate::BitReader;
///Field `MR19` writer - CPU interrupt mask on configurable event input x
pub type MR19_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MR20` reader - CPU interrupt mask on configurable event input x
pub type MR20_R = crate::BitReader;
///Field `MR20` writer - CPU interrupt mask on configurable event input x
pub type MR20_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MR21` reader - CPU interrupt mask on configurable event input x
pub type MR21_R = crate::BitReader;
///Field `MR21` writer - CPU interrupt mask on configurable event input x
pub type MR21_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MR22` reader - CPU interrupt mask on direct event input x
pub type MR22_R = crate::BitReader;
///Field `MR22` writer - CPU interrupt mask on direct event input x
pub type MR22_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MR23` reader - CPU interrupt mask on direct event input x
pub type MR23_R = crate::BitReader;
///Field `MR23` writer - CPU interrupt mask on direct event input x
pub type MR23_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MR24` reader - CPU interrupt mask on direct event input x
pub type MR24_R = crate::BitReader;
///Field `MR24` writer - CPU interrupt mask on direct event input x
pub type MR24_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MR25` reader - CPU interrupt mask on direct event input x
pub type MR25_R = crate::BitReader;
///Field `MR25` writer - CPU interrupt mask on direct event input x
pub type MR25_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MR26` reader - CPU interrupt mask on direct event input x
pub type MR26_R = crate::BitReader;
///Field `MR26` writer - CPU interrupt mask on direct event input x
pub type MR26_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MR27` reader - CPU interrupt mask on direct event input x
pub type MR27_R = crate::BitReader;
///Field `MR27` writer - CPU interrupt mask on direct event input x
pub type MR27_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MR28` reader - CPU interrupt mask on direct event input x
pub type MR28_R = crate::BitReader;
///Field `MR28` writer - CPU interrupt mask on direct event input x
pub type MR28_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MR29` reader - CPU interrupt mask on direct event input x
pub type MR29_R = crate::BitReader;
///Field `MR29` writer - CPU interrupt mask on direct event input x
pub type MR29_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MR30` reader - CPU interrupt mask on direct event input x
pub type MR30_R = crate::BitReader;
///Field `MR30` writer - CPU interrupt mask on direct event input x
pub type MR30_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MR31` reader - CPU interrupt mask on direct event input x
pub type MR31_R = crate::BitReader;
///Field `MR31` writer - CPU interrupt mask on direct event input x
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7R.html#EXTI:IMR1)*/
pub struct IMR1rs;
...
///`reset()` method sets IMR1 to value 0xffc0_0000
