...
///Field `FRAME` reader - frame number Compare 1 value for the absolute frame counter.
pub type FRAME_R = crate::FieldReader<u32>;
///Field `FRAME` writer - frame number Compare 1 value for the absolute frame counter.
