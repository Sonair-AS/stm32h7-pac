...
/**Option byte loading reset flag <sup>(1)</sup>
...
///Field `OBLRSTF` reader - Option byte loading reset flag <sup>(1)</sup>
...
///Field `BORRSTF` reader - BOR reset flag <sup>(1)</sup>
pub use OBLRSTF_R as BORRSTF_R;
///Field `PINRSTF` reader - pin reset flag (NRST) <sup>(1)</sup>
pub use OBLRSTF_R as PINRSTF_R;
///Field `PORRSTF` reader - POR/PDR reset flag <sup>(1)</sup>
pub use OBLRSTF_R as PORRSTF_R;
///Field `SFTRSTF` reader - system reset from CPU reset flag <sup>(1)</sup>
pub use OBLRSTF_R as SFTRSTF_R;
///Field `IWDGRSTF` reader - independent watchdog reset flag <sup>(1)</sup>
pub use OBLRSTF_R as IWDGRSTF_R;
///Field `WWDGRSTF` reader - window watchdog reset flag <sup>(1)</sup>
pub use OBLRSTF_R as WWDGRSTF_R;
///Field `LPWRRSTF` reader - reset due to illegal Stop or Standby flag
...
impl R {
    ...
    ///Bit 17 - Option byte loading reset flag <sup>(1)</sup>
    #[inline(always)]
    pub fn oblrstf(&self) -> OBLRSTF_R {
        OBLRSTF_R::new(((self.bits >> 17) & 1) != 0)
    }
    ///Bit 21 - BOR reset flag <sup>(1)</sup>
    #[inline(always)]
    pub fn borrstf(&self) -> BORRSTF_R {
        BORRSTF_R::new(((self.bits >> 21) & 1) != 0)
    }
    ///Bit 22 - pin reset flag (NRST) <sup>(1)</sup>
    #[inline(always)]
    pub fn pinrstf(&self) -> PINRSTF_R {
        PINRSTF_R::new(((self.bits >> 22) & 1) != 0)
    }
    ///Bit 23 - POR/PDR reset flag <sup>(1)</sup>
    #[inline(always)]
    pub fn porrstf(&self) -> PORRSTF_R {
        PORRSTF_R::new(((self.bits >> 23) & 1) != 0)
    }
    ///Bit 24 - system reset from CPU reset flag <sup>(1)</sup>
    #[inline(always)]
    pub fn sftrstf(&self) -> SFTRSTF_R {
        SFTRSTF_R::new(((self.bits >> 24) & 1) != 0)
    }
    ///Bit 26 - independent watchdog reset flag <sup>(1)</sup>
    #[inline(always)]
    pub fn iwdgrstf(&self) -> IWDGRSTF_R {
        IWDGRSTF_R::new(((self.bits >> 26) & 1) != 0)
    }
    ///Bit 28 - window watchdog reset flag <sup>(1)</sup>
    #[inline(always)]
    pub fn wwdgrstf(&self) -> WWDGRSTF_R {
        WWDGRSTF_R::new(((self.bits >> 28) & 1) != 0)
    }
    ///Bit 30 - reset due to illegal Stop or Standby flag
    #[inline(always)]
