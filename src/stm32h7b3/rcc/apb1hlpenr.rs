...
#[doc = "SWPMI peripheral clocks enable during CSleep mode Set and reset by software. The peripheral clocks of the SWPMI are the kernel clock selected by SWPMISEL and provided to swpmi_ker_ck input, and the rcc_pclk1 bus interface clock."]
pub use CRSLPEN_A as SWPMILPEN_A;
#[doc = "OPAMP peripheral clock enable during CSleep mode Set and reset by software."]
pub use CRSLPEN_A as OPAMPLPEN_A;
#[doc = "MDIOS peripheral clock enable during CSleep mode Set and reset by software."]
pub use CRSLPEN_A as MDIOSLPEN_A;
#[doc = "FDCAN peripheral clocks enable during CSleep mode Set and reset by software. The peripheral clocks of the FDCAN are: the kernel clock selected by FDCANSEL and provided to fdcan_clk input, and the rcc_pclk1 bus interface clock."]
pub use CRSLPEN_A as FDCANLPEN_A;
