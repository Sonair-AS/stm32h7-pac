...
///Field `AFCDIS` writer - absolute frame counter disable This bit disables the absolute frame counter.
pub type AFCDIS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ALCDIS` writer - absolute line counter disable This bit disables the absolute line counter.
pub type ALCDIS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RFC1DIS` writer - relative frame counter 1 disable This bit disables the relative frame counter 1.
pub type RFC1DIS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RFC2DIS` writer - relative frame counter 2 disable This bit disables the relative frame counter 2.
