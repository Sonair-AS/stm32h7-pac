...
///Field `MMISM` reader - Mode mismatch interrupt mask Note: Accessible in both device and host modes.
pub type MMISM_R = crate::BitReader;
///Field `MMISM` writer - Mode mismatch interrupt mask Note: Accessible in both device and host modes.
pub type MMISM_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OTGINT` reader - OTG interrupt mask Note: Accessible in both device and host modes.
pub type OTGINT_R = crate::BitReader;
///Field `OTGINT` writer - OTG interrupt mask Note: Accessible in both device and host modes.
pub type OTGINT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SOFM` reader - Start of frame mask Note: Accessible in both device and host modes.
pub type SOFM_R = crate::BitReader;
///Field `SOFM` writer - Start of frame mask Note: Accessible in both device and host modes.
pub type SOFM_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RXFLVLM` reader - Receive FIFO non-empty mask Note: Accessible in both device and host modes.
pub type RXFLVLM_R = crate::BitReader;
///Field `RXFLVLM` writer - Receive FIFO non-empty mask Note: Accessible in both device and host modes.
pub type RXFLVLM_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `NPTXFEM` reader - Non-periodic Tx FIFO empty mask Note: Only accessible in host mode.
pub type NPTXFEM_R = crate::BitReader;
///Field `NPTXFEM` writer - Non-periodic Tx FIFO empty mask Note: Only accessible in host mode.
pub type NPTXFEM_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `GINAKEFFM` reader - Global non-periodic IN NAK effective mask Note: Only accessible in device mode.
pub type GINAKEFFM_R = crate::BitReader;
///Field `GINAKEFFM` writer - Global non-periodic IN NAK effective mask Note: Only accessible in device mode.
pub type GINAKEFFM_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `GONAKEFFM` reader - Global OUT NAK effective mask Note: Only accessible in device mode.
pub type GONAKEFFM_R = crate::BitReader;
///Field `GONAKEFFM` writer - Global OUT NAK effective mask Note: Only accessible in device mode.
pub type GONAKEFFM_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ESUSPM` reader - Early suspend mask Note: Only accessible in device mode.
pub type ESUSPM_R = crate::BitReader;
///Field `ESUSPM` writer - Early suspend mask Note: Only accessible in device mode.
pub type ESUSPM_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `USBSUSPM` reader - USB suspend mask Note: Only accessible in device mode.
pub type USBSUSPM_R = crate::BitReader;
///Field `USBSUSPM` writer - USB suspend mask Note: Only accessible in device mode.
pub type USBSUSPM_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `USBRST` reader - USB reset mask Note: Only accessible in device mode.
pub type USBRST_R = crate::BitReader;
///Field `USBRST` writer - USB reset mask Note: Only accessible in device mode.
pub type USBRST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ENUMDNEM` reader - Enumeration done mask Note: Only accessible in device mode.
pub type ENUMDNEM_R = crate::BitReader;
///Field `ENUMDNEM` writer - Enumeration done mask Note: Only accessible in device mode.
pub type ENUMDNEM_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ISOODRPM` reader - Isochronous OUT packet dropped interrupt mask Note: Only accessible in device mode.
pub type ISOODRPM_R = crate::BitReader;
///Field `ISOODRPM` writer - Isochronous OUT packet dropped interrupt mask Note: Only accessible in device mode.
pub type ISOODRPM_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EOPFM` reader - End of periodic frame interrupt mask Note: Only accessible in device mode.
pub type EOPFM_R = crate::BitReader;
///Field `EOPFM` writer - End of periodic frame interrupt mask Note: Only accessible in device mode.
pub type EOPFM_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `IEPINT` reader - IN endpoints interrupt mask Note: Only accessible in device mode.
pub type IEPINT_R = crate::BitReader;
///Field `IEPINT` writer - IN endpoints interrupt mask Note: Only accessible in device mode.
pub type IEPINT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OEPINT` reader - OUT endpoints interrupt mask Note: Only accessible in device mode.
pub type OEPINT_R = crate::BitReader;
///Field `OEPINT` writer - OUT endpoints interrupt mask Note: Only accessible in device mode.
pub type OEPINT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `IISOIXFRM` reader - Incomplete isochronous IN transfer mask Note: Only accessible in device mode.
pub type IISOIXFRM_R = crate::BitReader;
///Field `IISOIXFRM` writer - Incomplete isochronous IN transfer mask Note: Only accessible in device mode.
pub type IISOIXFRM_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `IPXFRM_IISOOXFRM` reader -
pub type IPXFRM_IISOOXFRM_R = crate::BitReader;
///Field `IPXFRM_IISOOXFRM` writer -
pub type IPXFRM_IISOOXFRM_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FSUSPM` reader - Data fetch suspended mask Only accessible in peripheral mode.
pub type FSUSPM_R = crate::BitReader;
///Field `FSUSPM` writer - Data fetch suspended mask Only accessible in peripheral mode.
pub type FSUSPM_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RSTDETM` reader - Reset detected interrupt mask Note: Only accessible in device mode.
pub type RSTDETM_R = crate::BitReader;
///Field `RSTDETM` writer - Reset detected interrupt mask Note: Only accessible in device mode.
pub type RSTDETM_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRTIM` reader - Host port interrupt mask Note: Only accessible in host mode.
pub type PRTIM_R = crate::BitReader;
///Field `HCIM` reader - Host channels interrupt mask Note: Only accessible in host mode.
pub type HCIM_R = crate::BitReader;
///Field `HCIM` writer - Host channels interrupt mask Note: Only accessible in host mode.
pub type HCIM_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PTXFEM` reader - Periodic Tx FIFO empty mask Note: Only accessible in host mode.
pub type PTXFEM_R = crate::BitReader;
///Field `PTXFEM` writer - Periodic Tx FIFO empty mask Note: Only accessible in host mode.
pub type PTXFEM_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LPMINTM` reader - LPM interrupt mask Note: Accessible in both host and device modes.
pub type LPMINTM_R = crate::BitReader;
///Field `LPMINTM` writer - LPM interrupt mask Note: Accessible in both host and device modes.
pub type LPMINTM_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CIDSCHGM` reader - Connector ID status change mask Note: Accessible in both host and device modes.
pub type CIDSCHGM_R = crate::BitReader;
///Field `CIDSCHGM` writer - Connector ID status change mask Note: Accessible in both host and device modes.
pub type CIDSCHGM_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DISCINT` reader - Disconnect detected interrupt mask Note: Only accessible in host mode.
pub type DISCINT_R = crate::BitReader;
///Field `DISCINT` writer - Disconnect detected interrupt mask Note: Only accessible in host mode.
pub type DISCINT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SRQIM` reader - Session request/new session detected interrupt mask Note: Accessible in both host and device modes.
pub type SRQIM_R = crate::BitReader;
///Field `SRQIM` writer - Session request/new session detected interrupt mask Note: Accessible in both host and device modes.
pub type SRQIM_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `WUIM` reader - Resume/remote wakeup detected interrupt mask Note: Accessible in both host and device modes.
pub type WUIM_R = crate::BitReader;
///Field `WUIM` writer - Resume/remote wakeup detected interrupt mask Note: Accessible in both host and device modes.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H730.html#OTG1_HS_GLOBAL:GINTMSK)*/
