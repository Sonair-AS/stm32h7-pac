...
///Field `CLR_PGSERR` reader - Bank 1 PGSERR1 flag clear bit
pub type CLR_PGSERR_R = crate::BitReader;
///Field `CLR_PGSERR` writer - Bank 1 PGSERR1 flag clear bit
...
///Field `CLR_CRCRDERR` reader - Bank 1 CRCRDERR1 flag clear bit
pub type CLR_CRCRDERR_R = crate::BitReader;
///Field `CLR_CRCRDERR` writer - Bank 1 CRCRDERR1 flag clear bit
...
impl R {
    ...
    ///Bit 18 - Bank 1 PGSERR1 flag clear bit
    #[inline(always)]
    ...
    ///Bit 28 - Bank 1 CRCRDERR1 flag clear bit
    #[inline(always)]
