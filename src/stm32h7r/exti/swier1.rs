...
///Field `SWIER0` reader - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER0_R = crate::BitReader;
///Field `SWIER0` writer - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER0_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SWIER1` reader - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER1_R = crate::BitReader;
///Field `SWIER1` writer - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SWIER2` reader - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER2_R = crate::BitReader;
///Field `SWIER2` writer - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER2_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SWIER3` reader - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER3_R = crate::BitReader;
///Field `SWIER3` writer - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER3_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SWIER4` reader - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER4_R = crate::BitReader;
///Field `SWIER4` writer - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER4_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SWIER5` reader - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER5_R = crate::BitReader;
///Field `SWIER5` writer - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER5_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SWIER6` reader - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER6_R = crate::BitReader;
///Field `SWIER6` writer - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER6_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SWIER7` reader - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER7_R = crate::BitReader;
///Field `SWIER7` writer - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER7_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SWIER8` reader - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER8_R = crate::BitReader;
///Field `SWIER8` writer - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER8_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SWIER9` reader - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER9_R = crate::BitReader;
///Field `SWIER9` writer - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER9_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SWIER10` reader - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER10_R = crate::BitReader;
///Field `SWIER10` writer - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER10_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SWIER11` reader - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER11_R = crate::BitReader;
///Field `SWIER11` writer - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER11_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SWIER12` reader - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER12_R = crate::BitReader;
///Field `SWIER12` writer - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER12_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SWIER13` reader - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER13_R = crate::BitReader;
///Field `SWIER13` writer - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER13_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SWIER14` reader - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER14_R = crate::BitReader;
///Field `SWIER14` writer - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER14_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SWIER15` reader - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER15_R = crate::BitReader;
///Field `SWIER15` writer - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER15_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SWIER16` reader - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER16_R = crate::BitReader;
///Field `SWIER16` writer - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER16_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SWIER17` reader - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER17_R = crate::BitReader;
///Field `SWIER17` writer - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER17_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SWIER18` reader - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER18_R = crate::BitReader;
///Field `SWIER18` writer - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER18_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SWIER19` reader - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER19_R = crate::BitReader;
///Field `SWIER19` writer - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER19_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SWIER20` reader - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER20_R = crate::BitReader;
///Field `SWIER20` writer - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER20_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SWIER21` reader - Software interrupt on line x This bitfield alway returns 0 when read.
pub type SWIER21_R = crate::BitReader;
///Field `SWIER21` writer - Software interrupt on line x This bitfield alway returns 0 when read.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7R.html#EXTI:SWIER1)*/
pub struct SWIER1rs;
