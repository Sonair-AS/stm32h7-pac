...
///Field `PRIV(0-15)` reader - privileged state of channel x
pub type PRIV_R = crate::BitReader;
///Field `PRIV(0-15)` writer - privileged state of channel x
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#HPDMA:PRIVCFGR)*/
