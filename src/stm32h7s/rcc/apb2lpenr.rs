...
/**TIM1 peripheral clock enable in low-power mode
...
///Field `TIM1LPEN` reader - TIM1 peripheral clock enable in low-power mode
...
///Field `TIM1LPEN` writer - TIM1 peripheral clock enable in low-power mode
...
///Field `USART1LPEN` reader - USART1 peripheral clock enable in low-power mode
pub use TIM1LPEN_R as USART1LPEN_R;
///Field `SPI1LPEN` reader - SPI2S1 peripheral clock enable in low-power mode
pub use TIM1LPEN_R as SPI1LPEN_R;
///Field `SPI4LPEN` reader - SPI4 peripheral clock enable in low-power mode
pub use TIM1LPEN_R as SPI4LPEN_R;
///Field `TIM15LPEN` reader - TIM15 peripheral clock enable in low-power mode
pub use TIM1LPEN_R as TIM15LPEN_R;
///Field `TIM16LPEN` reader - TIM16 peripheral clock enable in low-power mode
pub use TIM1LPEN_R as TIM16LPEN_R;
///Field `TIM17LPEN` reader - TIM17 peripheral clock enable in low-power mode
pub use TIM1LPEN_R as TIM17LPEN_R;
///Field `TIM9LPEN` reader - TIM9 peripheral clock enable in low-power mode
pub use TIM1LPEN_R as TIM9LPEN_R;
///Field `SPI5LPEN` reader - SPI5 peripheral clocks enable in low-power mode
pub use TIM1LPEN_R as SPI5LPEN_R;
///Field `SAI1LPEN` reader - SAI1 peripheral clocks enable in low-power mode
pub use TIM1LPEN_R as SAI1LPEN_R;
///Field `SAI2LPEN` reader - SAI2 peripheral clocks enable in low-power mode
pub use TIM1LPEN_R as SAI2LPEN_R;
///Field `USART1LPEN` writer - USART1 peripheral clock enable in low-power mode
pub use TIM1LPEN_W as USART1LPEN_W;
///Field `SPI1LPEN` writer - SPI2S1 peripheral clock enable in low-power mode
pub use TIM1LPEN_W as SPI1LPEN_W;
///Field `SPI4LPEN` writer - SPI4 peripheral clock enable in low-power mode
pub use TIM1LPEN_W as SPI4LPEN_W;
///Field `TIM15LPEN` writer - TIM15 peripheral clock enable in low-power mode
pub use TIM1LPEN_W as TIM15LPEN_W;
///Field `TIM16LPEN` writer - TIM16 peripheral clock enable in low-power mode
pub use TIM1LPEN_W as TIM16LPEN_W;
///Field `TIM17LPEN` writer - TIM17 peripheral clock enable in low-power mode
pub use TIM1LPEN_W as TIM17LPEN_W;
///Field `TIM9LPEN` writer - TIM9 peripheral clock enable in low-power mode
pub use TIM1LPEN_W as TIM9LPEN_W;
///Field `SPI5LPEN` writer - SPI5 peripheral clocks enable in low-power mode
pub use TIM1LPEN_W as SPI5LPEN_W;
///Field `SAI1LPEN` writer - SAI1 peripheral clocks enable in low-power mode
pub use TIM1LPEN_W as SAI1LPEN_W;
///Field `SAI2LPEN` writer - SAI2 peripheral clocks enable in low-power mode
pub use TIM1LPEN_W as SAI2LPEN_W;
impl R {
    ///Bit 0 - TIM1 peripheral clock enable in low-power mode
    #[inline(always)]
    pub fn tim1lpen(&self) -> TIM1LPEN_R {
        TIM1LPEN_R::new((self.bits & 1) != 0)
    }
    ///Bit 4 - USART1 peripheral clock enable in low-power mode
    #[inline(always)]
    pub fn usart1lpen(&self) -> USART1LPEN_R {
        USART1LPEN_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 12 - SPI2S1 peripheral clock enable in low-power mode
    #[inline(always)]
    pub fn spi1lpen(&self) -> SPI1LPEN_R {
        SPI1LPEN_R::new(((self.bits >> 12) & 1) != 0)
    }
    ///Bit 13 - SPI4 peripheral clock enable in low-power mode
    #[inline(always)]
    pub fn spi4lpen(&self) -> SPI4LPEN_R {
        SPI4LPEN_R::new(((self.bits >> 13) & 1) != 0)
    }
    ///Bit 16 - TIM15 peripheral clock enable in low-power mode
    #[inline(always)]
    pub fn tim15lpen(&self) -> TIM15LPEN_R {
        TIM15LPEN_R::new(((self.bits >> 16) & 1) != 0)
    }
    ///Bit 17 - TIM16 peripheral clock enable in low-power mode
    #[inline(always)]
    pub fn tim16lpen(&self) -> TIM16LPEN_R {
        TIM16LPEN_R::new(((self.bits >> 17) & 1) != 0)
    }
    ///Bit 18 - TIM17 peripheral clock enable in low-power mode
    #[inline(always)]
    pub fn tim17lpen(&self) -> TIM17LPEN_R {
        TIM17LPEN_R::new(((self.bits >> 18) & 1) != 0)
    }
    ///Bit 19 - TIM9 peripheral clock enable in low-power mode
    #[inline(always)]
    pub fn tim9lpen(&self) -> TIM9LPEN_R {
        TIM9LPEN_R::new(((self.bits >> 19) & 1) != 0)
    }
    ///Bit 20 - SPI5 peripheral clocks enable in low-power mode
    #[inline(always)]
    pub fn spi5lpen(&self) -> SPI5LPEN_R {
        SPI5LPEN_R::new(((self.bits >> 20) & 1) != 0)
    }
    ///Bit 22 - SAI1 peripheral clocks enable in low-power mode
    #[inline(always)]
    pub fn sai1lpen(&self) -> SAI1LPEN_R {
        SAI1LPEN_R::new(((self.bits >> 22) & 1) != 0)
    }
    ///Bit 23 - SAI2 peripheral clocks enable in low-power mode
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#RCC:APB2LPENR)*/
