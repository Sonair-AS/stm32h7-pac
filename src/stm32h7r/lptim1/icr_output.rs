...
///Field `CMP2OKCF` writer - Compare register 2 update OK clear flag Writing 1 to this bit clears the CMP2OK flag in the LPTIM_ISR register. Note: If LPTIM does not implement at least 2 channels this bit is reserved. Refer to Section 26.3.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7R.html#LPTIM1:ICR_OUTPUT)*/
