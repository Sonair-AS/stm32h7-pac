...
///Field `FTHF` reader - RXFIFO threshold flag This bit is set by hardware, and cleared by the hardware when the RXFIFO level is lower than the threshold.
pub type FTHF_R = crate::BitReader;
///Field `DOVRF` reader - Data overflow flag This bit is set by hardware and cleared by software by writing this bit to 1.
pub type DOVRF_R = crate::BitReader;
///Field `DOVRF` writer - Data overflow flag This bit is set by hardware and cleared by software by writing this bit to 1.
pub type DOVRF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RXNEF` reader - RXFIFO not empty flag This bit is set and cleared by hardware according to the RXFIFO level.
pub type RXNEF_R = crate::BitReader;
///Field `SATF` reader - Saturation detection flag This bit is set by hardware and cleared by software by writing this bit to 1.
pub type SATF_R = crate::BitReader;
///Field `SATF` writer - Saturation detection flag This bit is set by hardware and cleared by software by writing this bit to 1.
pub type SATF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CKABF` reader - Clock absence detection flag This bit is set by hardware and cleared by software by writing this bit to 1.
pub type CKABF_R = crate::BitReader;
///Field `CKABF` writer - Clock absence detection flag This bit is set by hardware and cleared by software by writing this bit to 1.
pub type CKABF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RFOVRF` reader - Reshape filter overrun detection flag This bit is set by hardware and cleared by software by writing this bit to 1.
pub type RFOVRF_R = crate::BitReader;
///Field `RFOVRF` writer - Reshape filter overrun detection flag This bit is set by hardware and cleared by software by writing this bit to 1.
pub type RFOVRF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SDDETF` reader - Sound activity detection flag This bit is set by hardware and cleared by software by writing this bit to 1.
pub type SDDETF_R = crate::BitReader;
///Field `SDDETF` writer - Sound activity detection flag This bit is set by hardware and cleared by software by writing this bit to 1.
pub type SDDETF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SDLVLF` reader - Sound level value ready flag This bit is set by hardware and cleared by software by writing this bit to 1.
pub type SDLVLF_R = crate::BitReader;
///Field `SDLVLF` writer - Sound level value ready flag This bit is set by hardware and cleared by software by writing this bit to 1.
