...
///Field `LSECSSRA` reader - Re-Arm the LSECSS function
pub type LSECSSRA_R = crate::BitReader;
///Field `LSECSSRA` writer - Re-Arm the LSECSS function
...
impl R {
    ...
    ///Bit 12 - Re-Arm the LSECSS function
    #[inline(always)]
...
impl W {
    ...
    ///Bit 12 - Re-Arm the LSECSS function
    #[inline(always)]
    pub fn lsecssra(&mut self) -> LSECSSRA_W<'_, BDCRrs> {
