...
pub type TXRSTU_R = crate::BitReader<bool>;
#[doc = "Field `TxRSTU` writer - Timerx reset update"]
pub type TXRSTU_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIMDCR_SPEC, bool, O>;
#[doc = "Field `TxREPU` reader - Timer x Repetition update"]
pub type TXREPU_R = crate::BitReader<bool>;
#[doc = "Field `TxREPU` writer - Timer x Repetition update"]
pub type TXREPU_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIMDCR_SPEC, bool, O>;
...
impl W {
    ...
    #[doc = "Bit 18 - Timerx reset update"]
    #[inline(always)]
    pub fn tx_rstu(&mut self) -> TXRSTU_W<18> {
        TXRSTU_W::new(self)
    }
    #[doc = "Bit 17 - Timer x Repetition update"]
    #[inline(always)]
    pub fn tx_repu(&mut self) -> TXREPU_W<17> {
        TXREPU_W::new(self)
    }
    #[doc = "Bits 14:15 - Delayed CMP4 mode"]
    #[inline(always)]
