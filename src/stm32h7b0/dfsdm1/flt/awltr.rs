...
///Field `BKAWL(0-3)` reader - Break signal assignment to analog watchdog low threshold event BKAWL\[i\] = 0: Break i signal is not assigned to an analog watchdog low threshold event BKAWL\[i\] = 1: Break i signal is assigned to an analog watchdog low threshold event
...
///Field `BKAWL(0-3)` writer - Break signal assignment to analog watchdog low threshold event BKAWL\[i\] = 0: Break i signal is not assigned to an analog watchdog low threshold event BKAWL\[i\] = 1: Break i signal is assigned to an analog watchdog low threshold event
...
impl R {
    ...
    ///Bit 0 - Break signal assignment to analog watchdog low threshold event BKAWL\[i\] = 0: Break i signal is not assigned to an analog watchdog low threshold event BKAWL\[i\] = 1: Break i signal is assigned to an analog watchdog low threshold event
    #[inline(always)]
    pub fn bkawl0(&self) -> BKAWL_R {
        BKAWL_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Break signal assignment to analog watchdog low threshold event BKAWL\[i\] = 0: Break i signal is not assigned to an analog watchdog low threshold event BKAWL\[i\] = 1: Break i signal is assigned to an analog watchdog low threshold event
    #[inline(always)]
    pub fn bkawl1(&self) -> BKAWL_R {
        BKAWL_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - Break signal assignment to analog watchdog low threshold event BKAWL\[i\] = 0: Break i signal is not assigned to an analog watchdog low threshold event BKAWL\[i\] = 1: Break i signal is assigned to an analog watchdog low threshold event
    #[inline(always)]
    pub fn bkawl2(&self) -> BKAWL_R {
        BKAWL_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - Break signal assignment to analog watchdog low threshold event BKAWL\[i\] = 0: Break i signal is not assigned to an analog watchdog low threshold event BKAWL\[i\] = 1: Break i signal is assigned to an analog watchdog low threshold event
    #[inline(always)]
