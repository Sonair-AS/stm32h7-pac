...
impl RegisterBlock {
    ///0x00 - SRAM/NOR-flash chip-select control registers for bank 1
    #[inline(always)]
    ...
    ///0x08..0x14 - SRAM/NOR-flash chip-select control registers for bank %s
    ///
    ...
    ///0x08 - SRAM/NOR-flash chip-select control registers for bank 2
    #[inline(always)]
    pub const fn bcr2(&self) -> &BCR {
        self.bcr(0)
    }
    ///0x10 - SRAM/NOR-flash chip-select control registers for bank 3
    #[inline(always)]
    pub const fn bcr3(&self) -> &BCR {
        self.bcr(1)
    }
    ///0x18 - SRAM/NOR-flash chip-select control registers for bank 4
    #[inline(always)]
    ...
    ///0x8c - Attribute memory space timing registers
    #[inline(always)]
    ...
    ///0x104..0x114 - SRAM/NOR-flash write timing registers for bank %s
    ///
    ...
    ///0x104 - SRAM/NOR-flash write timing registers for bank 1
    #[inline(always)]
    pub const fn bwtr1(&self) -> &BWTR {
        self.bwtr(0)
    }
    ///0x10c - SRAM/NOR-flash write timing registers for bank 2
    #[inline(always)]
    pub const fn bwtr2(&self) -> &BWTR {
        self.bwtr(1)
    }
    ///0x114 - SRAM/NOR-flash write timing registers for bank 3
    #[inline(always)]
    pub const fn bwtr3(&self) -> &BWTR {
        self.bwtr(2)
    }
    ///0x11c - SRAM/NOR-flash write timing registers for bank 4
    #[inline(always)]
    pub const fn bwtr4(&self) -> &BWTR {
        self.bwtr(3)
    }
    ///0x140 - SDRAM Control registers for SDRAM memory bank 1
    #[inline(always)]
    pub const fn sdcr1(&self) -> &SDCR1 {
        &self.sdcr1
    }
    ///0x144 - SDRAM Control registers for SDRAM memory bank 2
    #[inline(always)]
    pub const fn sdcr2(&self) -> &SDCR2 {
        &self.sdcr2
    }
    ///0x148..0x150 - SDRAM Timing registers for SDRAM memory bank %s
    ///
    ...
    ///0x148 - SDRAM Timing registers for SDRAM memory bank 1
    #[inline(always)]
    pub const fn sdtr1(&self) -> &SDTR {
        self.sdtr(0)
    }
    ///0x14c - SDRAM Timing registers for SDRAM memory bank 2
    #[inline(always)]
...
/**BCR1 (rw) register accessor: SRAM/NOR-flash chip-select control registers for bank 1
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#FMC:BCR1)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#FMC:BTR[1])
...
pub mod btr;
/**BCR (rw) register accessor: SRAM/NOR-flash chip-select control registers for bank %s
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#FMC:PMEM)

For information about available fields see [`mod@pmem`] module*/
pub type PMEM = crate::Reg<pmem::PMEMrs>;
///Common memory space timing register
pub mod pmem;
/**PATT (rw) register accessor: Attribute memory space timing registers
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#FMC:PATT)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#FMC:ECCR)

For information about available fields see [`mod@eccr`] module*/
pub type ECCR = crate::Reg<eccr::ECCRrs>;
///ECC result registers
pub mod eccr;
/**BWTR (rw) register accessor: SRAM/NOR-flash write timing registers for bank %s
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#FMC:BWTR[1])

For information about available fields see [`mod@bwtr`] module*/
pub type BWTR = crate::Reg<bwtr::BWTRrs>;
///SRAM/NOR-flash write timing registers for bank %s
pub mod bwtr;
/**SDCR1 (rw) register accessor: SDRAM Control registers for SDRAM memory bank 1
...
pub mod sdcr1;
/**SDCR2 (rw) register accessor: SDRAM Control registers for SDRAM memory bank 2
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#FMC:SDCR2)
...
pub mod sdcr2;
/**SDTR (rw) register accessor: SDRAM Timing registers for SDRAM memory bank %s
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#FMC:SDTR[1])

For information about available fields see [`mod@sdtr`] module*/
pub type SDTR = crate::Reg<sdtr::SDTRrs>;
///SDRAM Timing registers for SDRAM memory bank %s
pub mod sdtr;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#FMC:SDRTR)
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#FMC:SDSR)
