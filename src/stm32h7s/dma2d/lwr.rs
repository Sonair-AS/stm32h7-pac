...
///Field `LW` reader - Line watermark for interrupt generation An interrupt is raised when the last pixel of the watermarked line has been transferred.
pub type LW_R = crate::FieldReader<u16>;
///Field `LW` writer - Line watermark for interrupt generation An interrupt is raised when the last pixel of the watermarked line has been transferred.
