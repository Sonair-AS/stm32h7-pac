...
///Field `PREALARM` reader - pre-alarm value Pre-alarm value of the watchdog counter.
pub type PREALARM_R = crate::FieldReader<u16>;
///Field `PREALARM` writer - pre-alarm value Pre-alarm value of the watchdog counter.
