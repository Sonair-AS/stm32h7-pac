...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#GPIOC:MODER)

For information about available fields see [`mod@moder`] module*/
pub type MODER = crate::Reg<moder::MODERrs>;
///GPIO port mode register
pub mod moder;
pub use crate::stm32h7s::gpioa::otyper;
pub use crate::stm32h7s::gpioa::OTYPER;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#GPIOC:PUPDR)

For information about available fields see [`mod@pupdr`] module*/
pub type PUPDR = crate::Reg<pupdr::PUPDRrs>;
///GPIO port pull-up/pull-down register
pub mod pupdr;
pub use crate::stm32h7s::gpioa::afrh;
pub use crate::stm32h7s::gpioa::afrl;
pub use crate::stm32h7s::gpioa::brr;
pub use crate::stm32h7s::gpioa::bsrr;
pub use crate::stm32h7s::gpioa::idr;
pub use crate::stm32h7s::gpioa::lckr;
pub use crate::stm32h7s::gpioa::odr;
pub use crate::stm32h7s::gpioa::AFRH;
pub use crate::stm32h7s::gpioa::AFRL;
pub use crate::stm32h7s::gpioa::BRR;
pub use crate::stm32h7s::gpioa::BSRR;
