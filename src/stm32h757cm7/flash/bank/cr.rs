...
///Field `PG` reader - Bank 1 internal buffer control bit
pub type PG_R = crate::BitReader;
///Field `PG` writer - Bank 1 internal buffer control bit
...
///Field `START` reader - Bank 1 erase start control bit
pub type START_R = crate::BitReader;
///Field `START` writer - Bank 1 erase start control bit
...
///Field `OPERRIE` reader - Bank 1 write
pub type OPERRIE_R = crate::BitReader;
///Field `OPERRIE` writer - Bank 1 write
...
///Field `CRCENDIE` reader - Bank 1 CRC end of calculation interrupt enable bit
pub type CRCENDIE_R = crate::BitReader;
///Field `CRCENDIE` writer - Bank 1 CRC end of calculation interrupt enable bit
pub type CRCENDIE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CRCRDERRIE` reader - Bank 1 CRC read error interrupt enable bit
pub type CRCRDERRIE_R = crate::BitReader;
///Field `CRCRDERRIE` writer - Bank 1 CRC read error interrupt enable bit
...
impl R {
    ...
    ///Bit 1 - Bank 1 internal buffer control bit
    #[inline(always)]
    pub fn pg(&self) -> PG_R {
    ...
    ///Bit 7 - Bank 1 erase start control bit
    #[inline(always)]
    ...
    ///Bit 27 - Bank 1 CRC end of calculation interrupt enable bit
    #[inline(always)]
    pub fn crcendie(&self) -> CRCENDIE_R {
        CRCENDIE_R::new(((self.bits >> 27) & 1) != 0)
    }
    ///Bit 28 - Bank 1 CRC read error interrupt enable bit
    #[inline(always)]
...
///`reset()` method sets CR to value 0x31
