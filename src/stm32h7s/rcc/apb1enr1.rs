...
///Field `TIM2EN` reader - TIM2 peripheral clock enable
pub type TIM2EN_R = crate::BitReader;
///Field `TIM2EN` writer - TIM2 peripheral clock enable
pub type TIM2EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIM3EN` reader - TIM3 peripheral clock enable
pub type TIM3EN_R = crate::BitReader;
///Field `TIM3EN` writer - TIM3 peripheral clock enable
pub type TIM3EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIM4EN` reader - TIM4 peripheral clock enable
pub type TIM4EN_R = crate::BitReader;
///Field `TIM4EN` writer - TIM4 peripheral clock enable
pub type TIM4EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIM5EN` reader - TIM5 peripheral clock enable
pub type TIM5EN_R = crate::BitReader;
///Field `TIM5EN` writer - TIM5 peripheral clock enable
pub type TIM5EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIM6EN` reader - TIM6 peripheral clock enable
pub type TIM6EN_R = crate::BitReader;
///Field `TIM6EN` writer - TIM6 peripheral clock enable
pub type TIM6EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIM7EN` reader - TIM7 peripheral clock enable
pub type TIM7EN_R = crate::BitReader;
///Field `TIM7EN` writer - TIM7 peripheral clock enable
pub type TIM7EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIM12EN` reader - TIM12 peripheral clock enable
pub type TIM12EN_R = crate::BitReader;
///Field `TIM12EN` writer - TIM12 peripheral clock enable
pub type TIM12EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIM13EN` reader - TIM13 peripheral clock enable
pub type TIM13EN_R = crate::BitReader;
///Field `TIM13EN` writer - TIM13 peripheral clock enable
pub type TIM13EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIM14EN` reader - TIM14 peripheral clock enable
pub type TIM14EN_R = crate::BitReader;
///Field `TIM14EN` writer - TIM14 peripheral clock enable
...
pub type SPDIFRXEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `USART2EN` reader - USART2peripheral clocks enable
pub type USART2EN_R = crate::BitReader;
///Field `USART2EN` writer - USART2peripheral clocks enable
...
///Field `I2C1_I3C1EN` reader - I2C1/I3C1 peripheral clocks enable
pub type I2C1_I3C1EN_R = crate::BitReader;
///Field `I2C1_I3C1EN` writer - I2C1/I3C1 peripheral clocks enable
pub type I2C1_I3C1EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ///Bit 0 - TIM2 peripheral clock enable
    #[inline(always)]
    pub fn tim2en(&self) -> TIM2EN_R {
        TIM2EN_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - TIM3 peripheral clock enable
    #[inline(always)]
    pub fn tim3en(&self) -> TIM3EN_R {
        TIM3EN_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - TIM4 peripheral clock enable
    #[inline(always)]
    pub fn tim4en(&self) -> TIM4EN_R {
        TIM4EN_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - TIM5 peripheral clock enable
    #[inline(always)]
    pub fn tim5en(&self) -> TIM5EN_R {
        TIM5EN_R::new(((self.bits >> 3) & 1) != 0)
    }
    ///Bit 4 - TIM6 peripheral clock enable
    #[inline(always)]
    pub fn tim6en(&self) -> TIM6EN_R {
        TIM6EN_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 5 - TIM7 peripheral clock enable
    #[inline(always)]
    pub fn tim7en(&self) -> TIM7EN_R {
        TIM7EN_R::new(((self.bits >> 5) & 1) != 0)
    }
    ///Bit 6 - TIM12 peripheral clock enable
    #[inline(always)]
    pub fn tim12en(&self) -> TIM12EN_R {
        TIM12EN_R::new(((self.bits >> 6) & 1) != 0)
    }
    ///Bit 7 - TIM13 peripheral clock enable
    #[inline(always)]
    pub fn tim13en(&self) -> TIM13EN_R {
        TIM13EN_R::new(((self.bits >> 7) & 1) != 0)
    }
    ///Bit 8 - TIM14 peripheral clock enable
    #[inline(always)]
    ...
    ///Bit 17 - USART2peripheral clocks enable
    #[inline(always)]
    ...
    ///Bit 21 - I2C1/I3C1 peripheral clocks enable
    #[inline(always)]
...
impl W {
    ...
    ///Bit 6 - TIM12 peripheral clock enable
    #[inline(always)]
    pub fn tim12en(&mut self) -> TIM12EN_W<'_, APB1ENR1rs> {
        TIM12EN_W::new(self, 6)
    }
    ///Bit 7 - TIM13 peripheral clock enable
    #[inline(always)]
    pub fn tim13en(&mut self) -> TIM13EN_W<'_, APB1ENR1rs> {
        TIM13EN_W::new(self, 7)
    }
    ///Bit 8 - TIM14 peripheral clock enable
    #[inline(always)]
    pub fn tim14en(&mut self) -> TIM14EN_W<'_, APB1ENR1rs> {
    ...
    ///Bit 16 - SPDIFRX peripheral clocks enable
    #[inline(always)]
    pub fn spdifrxen(&mut self) -> SPDIFRXEN_W<'_, APB1ENR1rs> {
    ...
    ///Bit 21 - I2C1/I3C1 peripheral clocks enable
    #[inline(always)]
    pub fn i2c1_i3c1en(&mut self) -> I2C1_I3C1EN_W<'_, APB1ENR1rs> {
    ...
    ///Bit 27 - HDMI-CEC peripheral clock enable
    #[inline(always)]
    pub fn cecen(&mut self) -> CECEN_W<'_, APB1ENR1rs> {
        CECEN_W::new(self, 27)
    }
    ///Bit 30 - UART7 peripheral clocks enable
    #[inline(always)]
    pub fn uart7en(&mut self) -> UART7EN_W<'_, APB1ENR1rs> {
        UART7EN_W::new(self, 30)
    }
    ///Bit 31 - UART8 peripheral clocks enable
    #[inline(always)]
    pub fn uart8en(&mut self) -> UART8EN_W<'_, APB1ENR1rs> {
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#RCC:APB1ENR1)*/
