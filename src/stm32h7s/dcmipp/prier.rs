...
///Field `ERRIE` reader - Synchronization error interrupt enable This bit is available only in embedded synchronization mode.
pub type ERRIE_R = crate::BitReader;
///Field `ERRIE` writer - Synchronization error interrupt enable This bit is available only in embedded synchronization mode.
