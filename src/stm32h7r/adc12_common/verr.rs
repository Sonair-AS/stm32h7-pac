...
///Field `MINREV` reader - Minor revision These bits returns the ADC IP minor revision
pub type MINREV_R = crate::FieldReader;
///Field `MAJREV` reader - Major revision These bits returns the ADC IP major revision
