...
impl CH {
    ///0x00 - BDMA channel 0 configuration register
    #[inline(always)]
...
/**CR (rw) register accessor: BDMA channel 0 configuration register
