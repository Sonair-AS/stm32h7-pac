...
///Field `MATCH` reader - Status match Value to be compared with the masked status register to get a match
pub type MATCH_R = crate::FieldReader<u32>;
///Field `MATCH` writer - Status match Value to be compared with the masked status register to get a match
