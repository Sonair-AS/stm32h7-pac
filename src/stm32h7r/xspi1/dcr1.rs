...
///Field `CKMODE` reader - clock mode 0/mode 3 This bit indicates the level taken by the CLK between commands (when NCS = 1).
pub type CKMODE_R = crate::BitReader;
///Field `CKMODE` writer - clock mode 0/mode 3 This bit indicates the level taken by the CLK between commands (when NCS = 1).
