...
///Field `ABMODE` reader - Alternate-byte mode This field defines the alternate byte phase mode of operation. Others: reserved
pub type ABMODE_R = crate::FieldReader;
///Field `ABMODE` writer - Alternate-byte mode This field defines the alternate byte phase mode of operation. Others: reserved
pub type ABMODE_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `ABDTR` reader - Alternate bytes double transfer rate This bit sets the DTR mode for the alternate bytes phase. Note: This field can be written only when BUSY = 0.
pub type ABDTR_R = crate::BitReader;
///Field `ABDTR` writer - Alternate bytes double transfer rate This bit sets the DTR mode for the alternate bytes phase. Note: This field can be written only when BUSY = 0.
...
///Field `DMODE` reader - Data mode This field defines the data phase mode of operation. Others: reserved
pub type DMODE_R = crate::FieldReader;
///Field `DMODE` writer - Data mode This field defines the data phase mode of operation. Others: reserved
