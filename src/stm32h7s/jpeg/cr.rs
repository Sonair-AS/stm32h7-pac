...
///Field `JCEN` reader - JPEG core enable This bit enables the JPEG codec core.
pub type JCEN_R = crate::BitReader;
///Field `JCEN` writer - JPEG core enable This bit enables the JPEG codec core.
pub type JCEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `IFTIE` reader - Input FIFO threshold interrupt enable This bit enables interrupt generation when the input FIFO reaches a threshold.
pub type IFTIE_R = crate::BitReader;
///Field `IFTIE` writer - Input FIFO threshold interrupt enable This bit enables interrupt generation when the input FIFO reaches a threshold.
pub type IFTIE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `IFNFIE` reader - Input FIFO not full interrupt enable This bit enables interrupt generation when the input FIFO is not empty.
pub type IFNFIE_R = crate::BitReader;
///Field `IFNFIE` writer - Input FIFO not full interrupt enable This bit enables interrupt generation when the input FIFO is not empty.
pub type IFNFIE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OFTIE` reader - Output FIFO threshold interrupt enable This bit enables interrupt generation when the output FIFO reaches a threshold.
pub type OFTIE_R = crate::BitReader;
///Field `OFTIE` writer - Output FIFO threshold interrupt enable This bit enables interrupt generation when the output FIFO reaches a threshold.
pub type OFTIE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OFNEIE` reader - Output FIFO not empty interrupt enable This bit enables interrupt generation when the output FIFO is not empty.
pub type OFNEIE_R = crate::BitReader;
///Field `OFNEIE` writer - Output FIFO not empty interrupt enable This bit enables interrupt generation when the output FIFO is not empty.
pub type OFNEIE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EOCIE` reader - End of conversion interrupt enable This bit enables interrupt generation at the end of conversion.
pub type EOCIE_R = crate::BitReader;
///Field `EOCIE` writer - End of conversion interrupt enable This bit enables interrupt generation at the end of conversion.
pub type EOCIE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `HPDIE` reader - Header parsing done interrupt enable This bit enables interrupt generation upon the completion of the header parsing operation.
pub type HPDIE_R = crate::BitReader;
///Field `HPDIE` writer - Header parsing done interrupt enable This bit enables interrupt generation upon the completion of the header parsing operation.
pub type HPDIE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `IDMAEN` reader - Input DMA enable Enables DMA request generation for the input FIFO.
pub type IDMAEN_R = crate::BitReader;
///Field `IDMAEN` writer - Input DMA enable Enables DMA request generation for the input FIFO.
pub type IDMAEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ODMAEN` reader - Output DMA enable Enables DMA request generation for the output FIFO.
pub type ODMAEN_R = crate::BitReader;
///Field `ODMAEN` writer - Output DMA enable Enables DMA request generation for the output FIFO.
pub type ODMAEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `IFF` writer - Input FIFO flush This bit flushes the input FIFO. Note: Reads always return 0.
pub type IFF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OFF` writer - Output FIFO flush This bit flushes the output FIFO. Note: Reads always return 0.
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7S.html#JPEG:CR)*/
pub struct CRrs;
