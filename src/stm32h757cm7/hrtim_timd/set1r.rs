...
pub use crate::stm32h757cm7::hrtim_tima::set1r::TIMBCMP1_R as TIMBCMP2_R;
...
pub use crate::stm32h757cm7::hrtim_tima::set1r::TIMBCMP1_W as TIMBCMP2_W;
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H757_CM7.html#HRTIM_TIMD:SET1R)*/
pub struct SET1Rrs;
