...
///Field `BKCMP8E` reader - tim_brk_cmp8 enable This bit enables the tim_brk_cmp8 for the timers tim_brk input. tim_brk_cmp8 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
pub type BKCMP8E_R = crate::BitReader;
///Field `BKCMP8E` writer - tim_brk_cmp8 enable This bit enables the tim_brk_cmp8 for the timers tim_brk input. tim_brk_cmp8 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
...
///Field `ETRSEL` reader - etr_in source selection These bits select the etr_in input source. ... Refer to Section 64.3.2: TIM1 pins and internal signals for product specific implementation. Note: These bits can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
pub type ETRSEL_R = crate::FieldReader;
///Field `ETRSEL` writer - etr_in source selection These bits select the etr_in input source. ... Refer to Section 64.3.2: TIM1 pins and internal signals for product specific implementation. Note: These bits can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
...
impl R {
    ...
    ///Bit 8 - tim_brk_cmp8 enable This bit enables the tim_brk_cmp8 for the timers tim_brk input. tim_brk_cmp8 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    #[inline(always)]
...
See register [structure](https://stm32-rs.github.io/stm32-rs/STM32H7R.html#TIM1:AF1)*/
pub struct AF1rs;
