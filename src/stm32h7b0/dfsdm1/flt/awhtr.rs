...
///Field `BKAWH(0-3)` reader - Break signal assignment to analog watchdog high threshold event BKAWH\[i\] = 0: Break i signal is not assigned to an analog watchdog high threshold event BKAWH\[i\] = 1: Break i signal is assigned to an analog watchdog high threshold event
...
///Field `BKAWH(0-3)` writer - Break signal assignment to analog watchdog high threshold event BKAWH\[i\] = 0: Break i signal is not assigned to an analog watchdog high threshold event BKAWH\[i\] = 1: Break i signal is assigned to an analog watchdog high threshold event
...
impl R {
    ...
    ///Bit 0 - Break signal assignment to analog watchdog high threshold event BKAWH\[i\] = 0: Break i signal is not assigned to an analog watchdog high threshold event BKAWH\[i\] = 1: Break i signal is assigned to an analog watchdog high threshold event
    #[inline(always)]
    pub fn bkawh0(&self) -> BKAWH_R {
        BKAWH_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Break signal assignment to analog watchdog high threshold event BKAWH\[i\] = 0: Break i signal is not assigned to an analog watchdog high threshold event BKAWH\[i\] = 1: Break i signal is assigned to an analog watchdog high threshold event
    #[inline(always)]
    pub fn bkawh1(&self) -> BKAWH_R {
        BKAWH_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - Break signal assignment to analog watchdog high threshold event BKAWH\[i\] = 0: Break i signal is not assigned to an analog watchdog high threshold event BKAWH\[i\] = 1: Break i signal is assigned to an analog watchdog high threshold event
    #[inline(always)]
    pub fn bkawh2(&self) -> BKAWH_R {
        BKAWH_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - Break signal assignment to analog watchdog high threshold event BKAWH\[i\] = 0: Break i signal is not assigned to an analog watchdog high threshold event BKAWH\[i\] = 1: Break i signal is assigned to an analog watchdog high threshold event
    #[inline(always)]
